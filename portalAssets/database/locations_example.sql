...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2016 at 11:46 AM
...
INSERT INTO `items` (`id`, `latitude`, `longitude`, `address`, `featured`, `title`, `location`, `phone`, `email`, `website`, `category`, `rating`, `url`, `marker_image`, `additional_info`, `description`, `ribbon`, `video`) VALUES
...
(3, NULL, NULL, 'Forest Hills, Queens, NY 11375, USA', 0, 'Food Festival', '23 Hillhaven Drive', '323-843-4729', '', '', 'Event', NULL, 'detail.html', 'assets/img/items/4.jpg', 'Starts at 19:00', 'Sed ac dolor auctor, elementum lacus vitae, efficitur magna. Quisque sed semper tellus', 'Last Tickets!', '');
