...
?>
    ...
    <div><img src="<?php echo $org_log; ?>" style="position:relative; display:inline-block; top:0; left:0;width:60px; vertical-align:middle;" /><h1 style="display:inline-block;vertical-align:middle; margin-left:20px; "><?php echo $ORG_NAME; ?></h1><span style="float:right"><?php echo $fromDate = date('d/M/Y', strtotime($this->input->post('fromDate'))); ?>-<?php echo $toDate = date('d/M/Y', strtotime($this->input->post('toDate'))); ?></span><hr style="border-color:orange;"><br><p align="center" style="font-size: 16px;"><b>Requisition Report</b></p></div>
      ...
      <table id="" border="1" rules="all" class="table table-striped table-bordered table-hover printable table-sm no-footer centered" cellspacing="0" width="100%" role="grid">
        ...
        <tbody>
           <?php $sn = 1; ?>
           <?php foreach ($requisition_item_info_report as $row): ?>

            <tr>
               <td style="text-align: center;"><?php echo $sn++; ?></td>
               <td><?php echo $row->ITEM_NAME; ?> </td>
               <td style="text-align: center;"><?php echo $row->REQUIREMENT_QTY; ?> (<?php echo $row->UNIT_NAME; ?>)</td>
