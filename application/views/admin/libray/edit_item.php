...
<div class="ibox float-e-margins">
  ...
  <div class="ibox-content">
   ...
   <form id="item_form" class="form-horizontal" action="" method="post"  enctype="multipart/form-data">
    <?php
      ...
      <section>
       <div class="">
        <div class="">
          ...
          <h4 style="color:green">Book Information</h4>

          <div class="">
            <div class="col-md-9">

              <div class="form-group">
                <label class="col-md-5 control-label">ISBN NO</label>

                <div class="col-md-5">
                  <input type="text" name="ISBN_NO" id="ISBN_NO"
                  value="<?php echo $item->ISBN_NO ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                  ...
                  class="form-control"  value="<?php echo $item->SUB_TITLE ?>"
                ...
                <div class="col-md-5">
                  ...
                  <select id="DEPARTMENT" name="DEPARTMENT" class="form-control">
                    ...
                    <?php foreach ($department as $row): ?>
                        <option value="<?php echo $row->LKP_ID ?>" <?php echo ( $item->DEPARTMENT == $row->LKP_ID) ? 'selected' : set_value('DEPARTMENT') ?>><?php echo $row->LKP_NAME ?></option>
                    <?php endforeach; ?>
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                  <input type="text" name="LANGUAGE" value="<?php echo $item->LANGUAGE ?>" id=""  class="form-control" placeholder="Language"/>
                  ...
                  <select id="AUTHOR_ID" name="AUTHOR_ID" class="form-control">
                    <option value="">-Select-</option>
                     <?php foreach ($author as $row): ?>
                        <option value="<?php echo $row->AUTHOR_ID ?>" <?php echo ( $item->AUTHOR_ID == $row->AUTHOR_ID) ? 'selected' : set_value('DEPARTMENT') ?>><?php echo $row->AUTHOR_NAME ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
...
<!--               <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                  ...
                  class="form-control" value="<?php echo $item->EDITION_NO ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                  ...
                  class="form-control" value="<?php echo $item->BOOK_CELL_NO ?>"
                  ...
                  <select id="BOOK_TYPE_ID" name="BOOK_TYPE_ID" class="form-control">
                    <option value="">-Select-</option>   
                     <?php foreach ($library_item_type as $row): ?>
                        <option value="<?php echo $row->LKP_ID ?>" <?php echo ( $item->BOOK_TYPE_ID == $row->LKP_ID) ? 'selected' : set_value('LKP_ID') ?>><?php echo $row->LKP_NAME ?></option>
                    <?php endforeach; ?>
                  </select>
                  <span class="red"></span>
                </div>
                  ...
                  <select id="SUPPILER_ID" name="SUPPILER_ID" class="form-control">
                    <option value="">-Select-</option>
                     ...
                     <?php foreach ($supplier as $row): ?>
                        <option value="<?php echo $row->SUPPLIER_ID ?>" <?php echo ( $item->SUPPILER_ID == $row->SUPPLIER_ID) ? 'selected' : set_value('SUPPLIER_ID') ?>><?php echo $row->FULL_ENAME ?></option>
                    <?php endforeach; ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                  ...
                  value="<?php echo $item->NUMBER_OF_PAGE ?>"
...
<!--               <div class="form-group">
                  ...
                  <select id="PUBLISHER_ID" name="PUBLISHER_ID" class="form-control">
                    <option value="">-Select-</option>
                     <?php //foreach ($publisher as $row): ?>
                        <option value="<?php //echo $row->PUBLISHER_ID ?>" <?php// echo ( $item->PUBLISHER_ID == $row->PUBLISHER_ID) ? 'selected' : set_value('PUBLISHER_ID') ?>><?php //echo $row->PUBLISHER_NAME ?></option>
                    <?php //endforeach; ?>
                  </select>
                </div>
              </div> -->
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                  ...
                  class="form-control numbersOnly"  value="<?php echo $item->PUBLICATION_YEAR ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                  ...
                  class="form-control"  value="<?php echo $item->PUBLICATION_PLACE ?>"
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="COMMENT" class="col-md-5 control-label">Comment / Note </label>

                <div class="col-md-5">
                  <textarea type="textarea" name="COMMENT" id="COMMENT"
                  class="form-control" value="<?php echo $item->COMMENT ?>"
                  placeholder=" Comment / Note"> <?php echo $item->COMMENT ?></textarea>
                  <span class="red"></span>
                </div>
