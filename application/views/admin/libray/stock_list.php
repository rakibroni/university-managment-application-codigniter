                ...
                <tbody>
                    <?php if (!empty($stock_item_list)): ?>
                        ...
                        <tr class="gradeX" id="row_<?php //echo $row->LIB_ITEM_NUMBER; ?>">
                                ...
                                <td> 
                                    <a class="label label-success deleteThis" id="<?php //echo $row->LIB_ITEM_NUMBER; ?>"
                                       title="View Complete  Information" data-action="inventory/showCompleterequisition" 
                                       data-type="edit" ><i class="fa fa-times"></i>
                                   </a>
                                </td>
                     </tr>
                     <?php } ?>
