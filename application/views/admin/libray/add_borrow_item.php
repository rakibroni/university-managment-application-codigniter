...
<div class="ibox float-e-margins">
  <div class="ibox-title">
    <h5>Add Item Borrow </h5>
    <a class="btn btn-primary btn-xs pull-right " href="<?php echo site_url()?>/library/borrowList"">All Borrow Item </a>

  </div>
  <div class="ibox-content">

   <form id="item_form" class="form-horizontal" action="libraryAddBookBorrow" method="post"  enctype="multipart/form-data">
    <?php
          ...
          <div class="">
            <div class="col-md-9">
              ...
              <div class="form-group">
                <label class="col-md-5 control-label">Library Member No<span class="red">*</span></label>

                <div class="col-md-5">
                  <input type="text" name="MEMBER_ID" id="MEMBER_ID"
                  value=""
                  class="form-control" placeholder="Library Member No" required  onchange="member()">
...
<div class="">
  <div class="col-md-12" style="padding-right: 0px !important;padding-left: 0px !important; width: 101%; margin-top: 1%;">
    ...
    <div class="form-group col-md-6"  id="memberProperty">
       
   </div>

    <div class="form-group  col-md-6"  id="libraryItem">
...
function member() {
  var singleValues = $( "#MEMBER_ID" ).val();
    $.ajax({
      
    type: 'POST',
    url: '<?php echo base_url(); ?>Library/libraryMemberDetails',
    data: {singleValues: singleValues},
    success: function (data) {
      $("#memberProperty").html(data)
    }
...
function libraryItem() {
  var stockID = $( "#STOCK_ID" ).val();
    ...
    type: 'POST',
    url: '<?php echo base_url(); ?>Library/libraryItemDetails',
