<div class="ibox-title alert-info">
	...
	<div class="ibox-tools">
							<span id="update_addressInfo_btn" title="Update Personal Info"
								  class="btn btn-success btn-xs pull-right"
								  data-action="admin/updateApplicantAddressInfo/<?php echo $applicant_id;?>"><i class="fa fa-edit"></i> Edit </span>
	</div>
	<?php endif; ?>
</div>
...
<script>
	$('#update_addressInfo_btn').click(function () {
