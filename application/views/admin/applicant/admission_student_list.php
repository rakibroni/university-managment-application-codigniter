                ...
                <?php if (!empty($applicant)): ?>
                    ...
                    <div class="ibox-content">
                        <form id="frmContent" method="post">
                            <div class="table-responsive contentArea loadAdmissionStudent" id="applicantList">
                                    ...
                                    foreach ($applicant as $row):
                                        ...
                                        <tr class="gradeX" id="row_<?php echo $row->APPLICANT_ID; ?>" >
                                            ...
                                            <td class="text-center"> 
                                                <a target="_blank" href="<?php echo base_url();?>/admin/applicantInfoPdf/<?php echo $row->APPLICANT_ID ?>" class="btn btn-xs btn-danger"><i class="fa fa-print "></i> </a></td>
                                        </tr>
                                    <?php  endforeach;  ?>
                                    </tbody>
    ...
    $(document).on("click", ".program_session_wise_applicant", function () {
        ...
        if(PROGRAM_ID =='' || YSESSION_ID=='' ){
            ...
            $.ajax({
                ...
                url: "<?php echo site_url() ?>/Admin/admission_student_list",
                beforeSend: function () {
