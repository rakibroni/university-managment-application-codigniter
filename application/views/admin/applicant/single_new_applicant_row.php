 <td ><?php echo $applicant->ADM_ROLL_NO ?></td>
                                ...
                                <td><?php echo $applicant->ELIGIBLE_ADM_REMARKS ?></td>
                                <td>
                                    <?php
                                        if($applicant->ELIGIBLE_BY_ADDMISSION_DEPT_STATUS == 1)
                                            echo "<span style='color: green;'>Approved</span>";
                                        else if($applicant->ELIGIBLE_BY_ADDMISSION_DEPT_STATUS == 0)
                                            echo "<span style='color: red;'>Rejected</span>";
                                        else
                                            echo "";
                                    ?>
                                </td>
                                <td><?php echo $applicant->ELIGIBLE_ADDMISSION_DEPT_DT ?></td>
