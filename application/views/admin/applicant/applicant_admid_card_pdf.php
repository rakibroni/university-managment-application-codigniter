...
<div id="printBox">
    <div style="width: 100%;border-bottom: 2px solid black;">
        ...
        <?php   $logo='assets/img/logo/kyau_web.jpg'; ?>
        <img width="150" height="40" src="<?php echo base_url($logo); ?>" style="margin:0 auto; border: 1px solid black;">
    ...
    <h4 style="width:100%;text-align:center; margin:10px 0 0 0; line-height:18px;">ADMIT CARD</h4><br>
            ...
            <tr class="r0 lastrow">
                <td style="" class="cell c0">
                    <table class="table table-bordered">
                        <tbody>
                        <tr class="r0">
                            <td style="" class="cell c0 lastcol"><b>Roll No.</b></td><td><span style="float:left; margin-right:5px;"><?php echo $applicant->ADM_ROLL_NO; ?></span></td>
                        </tr>
                        <tr class="r1">
                        ...
                        <tr class="r0 lastrow">
                            ...
                            <td style="" class="cell c1 lastcol"><?php echo $newStartTime.' - '.$newEndTime; ?></td>
                        </tr>
                        </tbody>
                    </table>
                </td>
