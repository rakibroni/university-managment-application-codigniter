...
<!--    --><?php if ($applicant_info->ELIGIBLE_BY_ADDMISSION_DEPT_STATUS != 1) : ?>
    <div class="ibox-tools">
                            <span id="update_academicInfo_btn" title="Update academic info"
                                  class="btn btn-success btn-xs pull-right"
                                  data-action="admin/updateApplicantAcademicInfo/<?php echo $applicant_id;?>"><i class="fa fa-edit"></i> Edit </span>
    </div>
<!--    --><?php endif; ?>
</div>
...
<script>
    $('#update_academicInfo_btn').click(function () {
