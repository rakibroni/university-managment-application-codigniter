            ...
            <form id="applicant">
                <div class="col-md-6">
                    <div class="form-group">
                        <select class="form-control required" name="PROGRAM_ID" id="PROGRAM_ID" data-tags="true"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <select class="form-control required" name="YSESSION_ID" id="YSESSION_ID" data-tags="true"
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <input type="button" class="btn btn-primary btn-sm program_session_wise_applicant "
                               value="Search">
                    </div>
                </div>
            </form>
            ...
            <div class="ibox float-e-margins">
                <?php if (!empty($applicant)): ?>
                    <div class="ibox-title">
                        <h5>Department head approved Applicant List</h5>
                    </div>
                    <div class="ibox-content">
                            ...
                            <div class="table-responsive contentArea" id="applicantList">
                                <table class="table table-striped table-bordered table-hover gridTable">
                                    ...
                                    foreach ($applicant as $row):
                                        ?>
                                        <tr class="gradeX <?php echo ($row->ELIGIBLE_BY_DEPT_HEAD_STATUS == 1) ? '' : 'danger' ?>"
                                            id="row_<?php echo $row->APPLICANT_ID; ?>">
                                            ...
                                            <td>
                                                ...
                                                else if ($row->APPROVE_FOR_ADMIT == '2')
                                            ...
                                            <td class="text-center">
                                                <?php if ($row->ELIGIBLE_BY_DEPT_HEAD_STATUS == 1) : ?>
                                                    <a class="label label-primary applicantApprove"
                                                       ...
                                                       title="Click For Approved">Approve</a> || <a
                                                            class="label label-danger applicantReject"
                                                            data-applicant="<?php echo $row->APPLICANT_ID; ?>"
    ...
    $(document).on("click", ".program_session_wise_applicant", function () {
        ...
        if (PROGRAM_ID == '' || YSESSION_ID == '') {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('admin/applicant_list_admit_card_prg_ses_wise')?>",
                beforeSend: function () {
