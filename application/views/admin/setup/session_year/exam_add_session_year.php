...
<form class="form-horizontal frmContent" id="year" method="post">
    <div class="block-flat">
        ...
        <div class="form-group"><label class="col-lg-3 control-label">Exam Session<span class="text-danger">*</span></label>
        ...
        <div class="form-group"><label class="col-lg-3 control-label">Is semester?</label>
            ...
            <div class="col-lg-9">
                ...
                <span class="help-block m-b-none">click on checkbox for Semester.</span>
            </div>
        </div>
    ...
    <div class="form-group">
        <div class="col-lg-offset-2 col-lg-10">
            <?php if ($ac_type == "edit") { ?>
                <input type="button" class="btn btn-primary btn-sm formSubmit" data-action="setup/updateExamSessionYear"
                       data-su-action="setup/examSessionYearList" data-type="list" value="Update">
            <?php } else { ?>
                <input type="button" class="btn btn-primary btn-sm formSubmit" data-action="setup/createExamSessionYear"
                       data-su-action="setup/examSessionYearList" data-type="list" value="Submit">
            <?php
            }
            ?>
