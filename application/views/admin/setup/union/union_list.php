<table class="table table-striped table-bordered table-hover gridTable">
    ...
    foreach ($union as $row) {
        ...
        <tr class="gradeX" id="row_<?php echo $row->UNION_ID; ?>">
            ...
            <td <?php echo ($row->ACTIVE_FLAG == 1) ? "" : "class='inactive'"; ?>><?php //echo $row->POST_OFFICE_ENAME;
                ?></td>

            <td <?php echo ($row->ACTIVE_FLAG == 1) ? "" : "class='inactive'"; ?>><?php //echo $row->THANA_ENAME;
                ?></td>

            <td <?php echo ($row->ACTIVE_FLAG == 1) ? "" : "class='inactive'"; ?>></td>
