...
<!--                </td>-->
            ...
            <tr>
                ...
                <td class="text-center">
                    <button class="btn btn-xs btn-primary" id="search_existing_students"><i class="fa fa-search"></i>
                        Search
                    </button>
                </td>
            </tr>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '#search_existing_students', function () {
            ...
            if (FACULTY_ID == '' || DEPT_ID == '' || PROGRAM_ID == '' ||  BATCH_ID == '' || SECTION_ID == '') {
                alert("Please select all fields");
            }
            else {
                $.ajax({
                    type: "POST",
                    url: '<?php echo site_url('exam/existingStudentSession') ?>',
                    data: {
