...
<div class="block-flat">
    <form class="form-horizontal frmContent" id="exam_type" method="post">
        ...
        if ($ac_type == 2) {
            ?>
            <input type="hidden" class="rowID" name="txtexam_typeId" value="<?php echo $exam_type->EXAM_MARKS_TYPE_ID ?>"/>
            <?php
        }
        ?>
        ...
        <div class="form-group"><label class="col-lg-4 control-label">Exam Title<span
            ...
            <div class="col-lg-6">
                <input type="text" name="exam_title" class="form-control required"
                       value="<?php echo ($ac_type == 2) ? $exam_type->MARKS_TITLE : '' ?>">
        ...
        <div class="form-group">
            <div class="col-lg-offset-4 col-lg-8">
                ...
                <?php if ($ac_type == 2) { ?>
                    <input type="button" class="btn btn-primary btn-sm formSubmit" data-action="exam/updateExamMarksType"
                           data-su-action="exam/examMarksTypeById" value="Update">
                <?php } else { ?>
                    <input type="button" class="btn btn-primary btn-sm formSubmit" data-action="exam/createExamMarksType"
                           data-su-action="exam/examMarksTypeList" data-type="list" value="submit">
                    <?php
                }
                ?>
