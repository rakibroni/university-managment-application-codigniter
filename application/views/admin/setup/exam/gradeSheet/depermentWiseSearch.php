...
?>
 <a class="btn btn-primary btn-sm pull-right" href="<?php echo site_url() ?>/exam/gradeSheet">List</a>
<div id='printablediv'>
    <div>
    <img src="<?php echo $org_log; ?>" style="position:relative; display:inline-block; top:0; left:0;width:60px; vertical-align:middle;" /><h1 style="display:inline-block;vertical-align:middle; margin-left:20px; ">
    <?php echo $ORG_NAME; ?></h1><hr style="border-color:orange;"><br>
    <p align="center" style="font-size: 16px;"><b><?php if(!empty($depWiseData)){ echo $depWiseData[0]->DEGREE_NAME .'-'.$depWiseData[0]->DEPT_NAME .'-'. $depWiseData[0]->EXAM_TITLE; }?>   
       Marks Distribution</b><br></p></div>
<!-- 
  ...
  <tbody>
     ...
     <?php 
if($depWiseData):
     foreach ($depWiseData as $row): ?>

        <tr>
           <td style="text-align: center;"><?php echo $sn++; ?></td>
           <td><?php echo $row->MARKS_TITLE; ?> </td>
           <td style="text-align: center;"><?php echo $row->MARKS_PER.'%'; ?></td>
       </tr>
   <?php  endforeach; 
