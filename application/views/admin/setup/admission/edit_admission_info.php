...
<style>
    ...
    #admission_data_time{display: <?php echo ($previous_adm_desc->DATE_TIME_STATUS =='NOTSAME')? 'none':'' ?>;}
</style>
<form class="form-horizontal frmContent" id="regPeriod" method="post">
    <div class="block-flat">        
       ...
       <div class="form-group">
        ...
        <div class="col-lg-5">
            ...
            value="<?php echo $previous_adm_desc->ADMPRG_TITLE ?>"
    ...
    <div class="form-group">
        ...
        <div class="col-lg-5">
            <textarea class="redactor" name="description"><?php echo $previous_adm_desc->ADMPRG_DESC ?></textarea>
            <span class="validation"></span>
    ...
    <div class="form-group">            
        ...
        <div class="col-lg-2">
            <input type="text" name="pFromDate"   class="form-control datepicker" readonly="readonly" placeholder="dd/mm/yy" value="<?php echo date('d-m-Y',strtotime($previous_adm_desc->REG_PRG_SDT ))?>">            
        ...
        <div class="col-lg-2">
            <input type="text" name="pToDate" class="form-control   datepicker" value="<?php echo date('d-m-Y',strtotime($previous_adm_desc->REG_PRG_EDT ))?>" readonly="readonly">
    ...
    <div class="form-group">            
        ...
        <div class="col-lg-5">
            <input type="radio" value="NOTSAME" name="date_time_status" class="date_time_status" <?php echo ($previous_adm_desc->DATE_TIME_STATUS =='NOTSAME')? 'checked':'' ?>> 
            Individual
            &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" value="SAME" class="date_time_status" name="date_time_status" <?php echo ($previous_adm_desc->DATE_TIME_STATUS =='SAME')? 'checked':'' ?>>            
            Same
        </div>
    ...
    <div id="admission_data_time"> 
        <div class="form-group">            
            ...
            <div class="col-lg-2">
                ...
                <input type="text" name="tFromDateCommon" class="form-control datepicker  " value="<?php if(!empty($same_data_time)){echo data('d-m-Y',strtotime( $same_data_time->PRG_EXM_SDT));} ?>">
            ...
            <div class="col-lg-2">
                <div id="data_1">
                    <div class="input-group clockpicker" data-autoclose="true">
                        ...
                        <input type="text" name="timeFromCommon" class="form-control  " value="<?php echo $same_data_time->PRG_EXM_STM ?>">
                    </div>
                </div>
            ...
            <div class="col-lg-2">
                <div id="data_1">
                    <div class="input-group clockpicker" data-autoclose="true">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        <input type="text" name="timeToCommon" class="form-control  " value="<?php echo $same_data_time->PRG_EXM_ETM ?>">
                    </div>
                </div>
                <span class="help-block m-b-none ">e.g.  9.30 am</span>
            </div>
...
<?php if($previous_adm_desc->DATE_TIME_STATUS =='NOTSAME'){?>
...
<?php }else{ ?>
    ...
    $('#program_table td:nth-child(3),#program_table th:nth-child(3)').hide();
    <?php } ?>
    $( function() {
