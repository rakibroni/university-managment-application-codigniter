        ...
        <td <?php echo ($row->ACTIVE_STATUS == 1) ? "" : "class='inactive'"; ?>>
            <?php if ($previlages->UPDATE == 1) { ?>
                <a class="label label-default openModal" id="<?php echo $row->BR_ACCESSORY_ID; ?>"
                   title="Update Accessory Information" data-action="setup/accessoryFormUpdate" data-type="edit"><i
            ...
            if ($previlages->DELETE == 1) {
                ...
                <a class="label label-danger deleteItem" id="<?php echo $row->BR_ACCESSORY_ID; ?>"
                   title="Click For Delete" data-type="delete" data-field="BR_ACCESSORY_ID" data-tbl="sc_accessories"><i
