               ...
               <table style="padding: 10px;font-size:14px; width:100%;">
                <tr>
                  <td style="padding:10px;font-size:14px; width:100%;">
                   Dear <?php echo $fullName->FULL_ENAME; ?>,<br><br>Welcome to the University Management community!<br><br> You are one step away to become an user. Please, follow the link below to activate your account. If you cannot click the URL below, please copy and paste it into your web browser.<br><?php echo base_url("") ?> <br>After that, you can immediately start using your new credentials on http://www.kyau.edu.bd<br>Your User Name : <?php echo  $Uemail; ?><br>Password : 123456 <br><br>
