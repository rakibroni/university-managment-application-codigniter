...
<form class="form-horizontal frmContent" id="event" method="post">
    <div class="block-flat">
        ...
        <div class="form-group"><label class="col-lg-2 control-label">Title *</label>
            ...
            <div class="col-lg-6">
                <input type="text" id="eventName" name="weekendTitle"
        ...
        <div class="hr-line-dashed"></div>
        <div class="form-group"><label class="col-lg-2 control-label">Day *</label>

            <div class="col-lg-8">
                <label class="checkbox-inline"><input type="checkbox" class="txtHoliday" name="txtHolidayDay[]"
                ...
                <label class="checkbox-inline"><input type="checkbox" class="txtHoliday" name="txtHolidayDay[]"
                                                      value="1">Monday</label><br>
                <label class="checkbox-inline"><input type="checkbox" class="txtHoliday" name="txtHolidayDay[]"
                                                      value="2">Tuesday</label>
                <label class="checkbox-inline"><input type="checkbox" class="txtHoliday" name="txtHolidayDay[]"
                                                      value="3">Wednesday</label>
                <label class="checkbox-inline"><input type="checkbox" class="txtHoliday" name="txtHolidayDay[]"
                                                      value="5">Thursday</label>
                <span class="validation"></span>
                <span class="help-block m-b-none">e.g.  Select Weekend day.</span>
            </div>
        </div>
        <div class="hr-line-dashed"></div>
    ...
    <div class="form-group">
        <div class="col-lg-offset-2 col-lg-10">
            ...
            <?php } else { ?>
                <input type="button" class="btn btn-primary btn-sm formSubmit" data-action="setup/createWeekend"
...
<script>
    /*$(document).on("click", "#formSubmit", function() {
     if(!$('#formSubmit input[type="checkbox"]').is(':checked')){
