...
<table class="table table-bordered gridTable">
    ...
    <tbody>
        <?php if (!empty($buildings)): $sn = 1; ?>

            <?php foreach ($buildings as $row) { ?>
            <tr class="gradeX" id="row_<?php echo $row->BUILDING_ID; ?>">
                     ...
                     <a class="label label-default openModal" id="<?php echo $row->BUILDING_ID; ?>"
                       ...
                       if ($previlages->DELETE == 1) {
                           ...
                           <a class="label label-danger deleteItem2" id="<?php echo $row->BUILDING_ID; ?>"
                               title="Click For Delete" data-type="delete" data-action="setup/deleteItem"
                               data-field="BUILDING_ID" data-tbl="sa_building"><i
