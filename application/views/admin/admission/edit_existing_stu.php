    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                <!--                <a href="<?php echo base_url(); ?>admin/applicants"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-arrow-left"></i> Back</button></a>-->
            </div>
        </div>
        <form class="form-horizontal" id="existingStu"
              action="<?php echo base_url(); ?>admission/updateExistingStu/<?php echo $applicant->STUDENT_ID ?>"
            ...
            <div class="col-md-12">
                <div class="ibox-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="FULL_NAME_EN" id="FULL_NAME_EN"
                                               value="<?php echo $applicant->FULL_NAME_EN ?>" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="hidden" name="STU_PARENT_ID_F"
                                           value="<?php echo $fathersInfo->STU_PARENT_ID ?>">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control" name="FATHER_OCU" id="FATHER_OCU">
                                        ...
                                        <?php foreach ($occupation as $row) { ?>
                                            <option
                                                value="<?php echo $row->LKP_ID ?>" <?php echo ($fathersInfo->OCCUPATION == $row->LKP_ID) ? 'selected' : '' ?>><?php echo $row->LKP_NAME ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <table id="mobile_list_f">
                                        <tbody>
                                        <?php foreach ($father_contact as $row): ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <table id="email_list_f">
                                        <tbody>
                                        <?php foreach ($father_email as $row): ?>
                                            <tr id="row_id_<?php echo $row->STU_PGS_ID ?>">
                                                <td>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="MOTHER_NAME" id="MOTHER_NAME"
                                           value="<?php echo $applicant->MOTHER_NAME ?>" class="form-control"
                                           placeholder="Mother's Name" required>
                                    <input type="hidden" name="STU_PARENT_ID_M"
                                           value="<?php echo $motherInfo->STU_PARENT_ID ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <select class="form-control" name="MOTHER_OCU" id="MOTHER_OCU">
                                        ...
                                        <?php foreach ($occupation as $row) { ?>
                                            <option
                                                value="<?php echo $row->LKP_ID ?>" <?php echo ($motherInfo->OCCUPATION == $row->LKP_ID) ? 'selected' : '' ?>><?php echo $row->LKP_NAME ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <table id="mobile_list_m">
                                        <tbody>
                                        <?php foreach ($mother_contact as $row): ?>
                                            <tr id="row_id_<?php echo $row->STU_PGS_ID ?>">
                                                <td>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                ...
                                <input type="hidden" name="STU_ADRESS_ID_PS"
                                       value="<?php echo $addrInfo->STU_ADRESS_ID ?>">
                                ...
                                <div class="col-md-3">
                                    <select name="DIVISION_ID" id="DIVISION_ID" class="form-control"
                                        ...
                                        <?php foreach ($division as $rd) { ?>
                                            <option
                                                value="<?php echo $rd->DIVISION_ID ?>" <?php echo ($addrInfo->DIVISION_ID == $rd->DIVISION_ID) ? 'selected' : '' ?>><?php echo $rd->DIVISION_ENAME ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <select name="DISTRICT_ID" id="DISTRICT_ID" class="form-control" required>
                                        ...
                                        <?php foreach ($district as $rd) { ?>
                                            <option
                                                value="<?php echo $rd->DISTRICT_ID ?>" <?php echo ($addrInfo->DISTRICT_ID == $rd->DISTRICT_ID) ? 'selected' : '' ?>><?php echo $rd->DISTRICT_ENAME ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <select name="THANA_ID" id="THANA_ID" class="form-control" required>
                                        ...
                                        <?php foreach ($thana as $rd) { ?>
                                            <option
                                                value="<?php echo $rd->THANA_ID ?>" <?php echo ($addrInfo->THANA_ID == $rd->THANA_ID) ? 'selected' : '' ?>><?php echo $rd->THANA_ENAME ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <select name="POLICE_STATION_ID" id="POLICE_STATION_ID" class="form-control"
                                        ...
                                        <?php foreach ($police_station as $rd) { ?>
                                            <option
                                                value="<?php echo $rd->POLICE_STATION_ID ?>" <?php echo ($addrInfo->POLICE_STATION_ID == $rd->POLICE_STATION_ID) ? 'selected' : '' ?>><?php echo $rd->PS_ENAME ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <select name="UNION_ID" id="UNION_ID" class="form-control" required>
                                        ...
                                        <?php foreach ($union as $rd) { ?>
                                            <option
                                                value="<?php echo $rd->UNION_ID ?>" <?php echo ($addrInfo->UNION_ID == $rd->UNION_ID) ? 'selected' : '' ?>><?php echo $rd->UNION_NAME ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <select name="POST_OFFICE_ID" id="POST_OFFICE_ID" class="form-control">
                                        ...
                                        <?php foreach ($post_office as $rd) { ?>
                                            <option
                                                value="<?php echo $rd->POST_OFFICE_ID ?>" <?php echo ($addrInfo->POST_OFFICE_ID == $rd->POST_OFFICE_ID) ? 'selected' : '' ?>><?php echo $rd->POST_OFFICE_ENAME ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" name="VILLAGE" id="VILLAGE"
                                           value="<?php echo $addrInfo->VILLAGE_WARD ?>" class="form-control" required/>
                                </div>
                                <div class="col-md-3">
                                    <i class="fa fa-info-circle pointer2"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="radio" class="SAS_PSORPR" name="SAS_PSORPR" value="1"
                                       id="PARM_ADDRESS_YES" <?php echo ($addrInfo->SAS_PSORPR == 'PS') ? 'checked' : ''; ?>>&nbsp;
                                Yes
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <table class="table table-bordered" id="ext_act_list">
                                    <tbody>
                                    <?php foreach ($extra_activity as $row): ?>
                            ...
                            <div class="col-md-2">
                                <div class="input-group date">
                                    ...
                                    <input type="text" readonly="" required="required" class="form-control datepicker"
                                           ...
                                           value="<?php echo $admission->ADMISSION_DATE ?>">
                                    <input type="hidden" name="STU_ADMISSION_ID"
                                           value="<?php echo $admission->STU_ADMISSION_ID ?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <select class="form-control" name="SESSION" id="SESSION" required>
                                    ...
                                    <?php foreach ($session as $row) { ?>
                                        <option
                                            value="<?php echo $row->SESSION_ID ?>" <?php echo ($admission->SESSION_ID == $row->SESSION_ID) ? 'selected' : ''; ?>><?php echo $row->SESSION_NAME ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="FACULTY" id="FACULTY">
                                    ...
                                    <?php foreach ($faculty as $row) { ?>
                                        <option
                                            value="<?php echo $row->FACULTY_ID ?>" <?php echo ($admission->FACULTY_ID == $row->FACULTY_ID) ? 'selected' : ''; ?>><?php echo $row->FACULTY_NAME ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="DEPT_ID" id="DEPT_ID" required>
                                    ...
                                    <?php foreach ($department as $row) { ?>
                                        <option
                                            value="<?php echo $row->DEPT_ID ?>" <?php echo ($admission->DEPT_ID == $row->DEPT_ID) ? 'selected' : ''; ?>><?php echo $row->DEPT_NAME ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="PROGRAM_ID" id="PROGRAM_ID" required>
                                    ...
                                    <?php foreach ($program as $row) { ?>
                                        <option
                                            value="<?php echo $row->PROGRAM_ID ?>" <?php echo ($admission->PROGRAM_ID == $row->PROGRAM_ID) ? 'selected' : ''; ?>><?php echo $row->PROGRAM_NAME ?></option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="col-md-2">
                                <select class="form-control" name="SEMESTER" id="SEMESTER" required>
                                    ...
                                    <?php foreach ($semester as $row) { ?>
                                        <option
                                            value="<?php echo $row->LKP_ID ?>" <?php echo ($admission->SEMISTER_ID == $row->LKP_ID) ? 'selected' : ''; ?>><?php echo $row->LKP_NAME ?></option>
                                    <?php } ?>
                                </select>
                                ...
                                <div id="offer_course_list_div" class="toggle-div-course-e flexy">
                                    <table width="50%" id="offer_course_list" class="table table-bordered">
                                        ...
                                        $courses_list = $this->db->query("SELECT a.*,
                                                                            ...
                                                                            WHERE a.FACULTY_ID = $admission->FACULTY_ID AND a.DEPT_ID = $admission->DEPT_ID AND a.PROGRAM_ID = $admission->PROGRAM_ID")->result();
                                        $stu_courses = $this->db->query("SELECT co.COURSE_ID
                                                                        ...
                                                                        WHERE co.FACULTY_ID = $admission->FACULTY_ID AND co.DEPT_ID = $admission->DEPT_ID AND co.PROGRAM_ID =$admission->PROGRAM_ID AND c.STUDENT_ID = $admission->STUDENT_ID AND c.IS_CURRENT = 1")->result();
                                        ?>
                                        <tbody>
                                        <?php
                                        $course_array = array();
                                        ...
                                        for ($i = 0; $i < sizeof($courses_list); $i++) {
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="checkbox" <?php echo $is_checked; ?> name="COURSE_ID[]"
                    ...
                    <div class="div-background">
                        <div class="form-group">
                            <label class="col-md-3 control-label">Roll No. <span class="red">*</span></label>

                            <div class="col-md-2">
                                <input type="text" name="ROLL_NO" id="ROLL_NO" placeholder="Roll No."
                                       value="<?php echo $applicant->ROLL_NO ?>" class="form-control" required>
                            </div>
                            <div class="col-md-3">
                                <i class="fa fa-info-circle pointer2"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="password" name="PASSWORD" id="PASSWORD"
                                       value="<?php echo $applicant->PASSWORD ?>" placeholder="User Password"
    ...
    $(document).on('click', '.delete_row_data', function () {
        if (confirm("Are you sure?")) {
            ...
            if (image_name != "") {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>admission/delImage',
                    data: {
