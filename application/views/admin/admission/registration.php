                ...
                <div class="ibox-content">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="FULL_NAME_EN" id="FULL_NAME_EN"
                                           value="<?php echo set_value('FULL_NAME_EN') ?>" class="form-control"
                                ...
                                <div class="col-md-3">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="DATH_OF_BIRTH" id="DATH_OF_BIRTH"
                                               ...
                                               value="<?php echo set_value('DATH_OF_BIRTH'); ?>" required="required"
                                               readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1" style="padding-right: 0;">
                                    <input type="text" name="HEIGHT_FEET" id="HEIGHT_FEET" value="" class="form-control numbersOnly" placeholder="e.g: 5.8">
                                </div>
                                <div class="col-md-1">
                                    Ft.
                                </div>
                                <div class="col-md-2" style="padding-right: 0;">
                                    <input type="text" name="HEIGHT_CM" id="HEIGHT_CM" value=""  class="form-control numbersOnly" placeholder="e.g: 176.78">
                                </div>
                                <div class="col-md-1">
                                    Cm.
                                </div>
                    ...
                    <div class="div-background">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <select class="form-control" name="" id="ACTIVITY_TYPE_ID">
                                    <option value="">-Select-</option>
                            ...
                            <div class="col-md-2">
                                <textarea type="text" name="" id="DESCRIPTION" value="" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1  ">
                                <input type="text" name="WEAVER_PERCENTAGE" id="WEAVER_PERCENTAGE" placeholder="e.g. 5%"
                                       value="" class="form-control numbersOnly">
                            </div>
                            <div class="col-md-1  ">
                                <i class="fa fa-info-circle pointer2"
                    ...
                    <div class="div-background">
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" name="ROLL_NO" id="ROLL_NO" placeholder="Roll No." value=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="password" name="PASSWORD" id="PASSWORD"
                                       value="<?php echo set_value('PASSWORD'); ?>" placeholder="User Password"
                                       class="form-control" required>
