                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion"
                               href="#collapseOne">
                                <h4 class="panel-title"><?php echo $student_info->STUDENT_NAME; ?>
                                    - <?php echo $student_info->SESSION_NAME; ?></h4>
                            </a>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body">
                                <address>
                                    <strong>Faculty:</strong> <?php echo $student_info->FACULTY; ?><br/>
                                    <strong>Department:</strong> <?php echo $student_info->DEPARTMENT; ?><br/>
                                    <strong>Program:</strong> <?php echo $student_info->PROGRAM; ?><br/>
                                    <strong>Session:</strong> <?php echo $student_info->SESSION_NAME; ?><br/>
                                    <strong>Semester:</strong> <?php echo $student_info->SEMISTER; ?>
                                </address>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 tooltip-demo">
                <div class="ibox float-e-margins">
                    <div class="ibox-content" style="padding: 3px;">
                        ...
                        <div class="">
                            <select name="cmbSemester" class="form-control" id="cmbSemester"
                                    style="background: #1AB394; color: #fff;">
                                <option value="">Select Semester</option>
                                <option value="all">All</option>
                                <?php
                                foreach ($semesters as $semester) {
                                    $selected = ($student_info->SEMISTER_ID == $semester->SEMESTER_ID) ? "selected='selected'" : "";
                                    ?>
                                    <option value="<?php echo $semester->SEMESTER_ID ?>" data-session="<?php echo $semester->SESSION_ID ?>" <?php echo $selected; ?>
                                            data-numb="<?php echo $semester->NUMB_LKP ?>"><?php echo $semester->LKP_NAME; ?>
                                        - <?php echo $semester->SESSION_NAME; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="ibox-content">
                        <div>
                            ...
                            <div class="col-sm-6">
                                ...
                                if (!empty($student_info)) {
                                    ...
                                    <input type="hidden" value="<?php echo $student_info->ROLL_NO; ?>" name="txtRollNo" id="txtRollNo"/>
                                    ...
                                    <input type="hidden" value="<?php echo $student_info->SEMISTER_ID; ?>" name="txtSemister" id="txtSemister"/>
                                <?php } ?>
                            </div>
                            <br clear="all"/>
                        </div>
                        ...
                        <table class="table invoice-total ">
                            ...
                            <tr>
                                ...
                                <td class="text-danger" style="background-color:#F3F3F4;"><input type="text"
                                                                                                 name="txtPayment[]"
                                                                                                 id="txtPayment"
                                                                                                 placeholder="00.00"
