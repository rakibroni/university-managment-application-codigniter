...
if (!empty($applicant_info)) {
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion"
                               href="#collapseOne">
                                <h4 class="panel-title"><?php echo $applicant_info->FULL_NAME_EN; ?> - <?php echo $applicant_info->SESSION_NAME; ?></h4>
                            </a>
                        </div>
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body">
                                <address>
                                    <strong>Faculty:</strong> <?php echo $applicant_info->FACULTY_NAME; ?><br/>
                                    <strong>Department:</strong> <?php echo $applicant_info->DEPT_NAME; ?><br/>
                                    <strong>Program:</strong> <?php echo $applicant_info->PROGRAM_NAME; ?><br/>
                                    <strong>Session:</strong> <?php echo $applicant_info->SESSION_NAME; ?><br/>
                                    <strong>Semester:</strong> <?php echo $applicant_info->SEMESTER_NAME; ?><br/>
                                </address>
                            </div>
                        </div>
                    </div>
        ...
        <form id="frmPayment" action="<?php echo site_url('payment/doApplicantPayment'); ?>" method="post">
                    ...
                    <div class="ibox-content" style="padding: 3px;">
                        ...
                        <div class="">
                            <select name="cmbSemester" class="form-control" id="cmbSemester" style="background: #1AB394; color: #fff;">
                                <option value="<?php echo $applicant_info->SEMESTER_SL_NO ?>"><?php echo $applicant_info->SEMESTER_NAME; ?> - <?php echo $applicant_info->SESSION_NAME; ?></option>                                
                            </select>
                        </div>
                        <ul class="todo-list m-t small-list" id="expenseList">
                            <?php $this->load->view("admin/payment/stu_expense_details", true); ?>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="ibox-content">
                        <div>
                            ...
                            <div class="col-sm-6">
                                ...
                                if (!empty($applicant_info)) {
                                    ?>
                                    <input type="hidden" value="<?php echo $applicant_info->STUDENT_ID; ?>" name="txtApplicant" id="txtApplicant"/>
                                    <input type="hidden" value="<?php echo $applicant_info->REGISTRATION_NO; ?>" name="txtRollNo"  id="txtRollNo"/>
                                    <input type="hidden" value="<?php echo $applicant_info->FACULTY_ID; ?>" name="txtFaculty" id="txtFaculty"/>
                                    <input type="hidden" value="<?php echo $applicant_info->DEPT_ID; ?>" name="txtDept" id="txtDept"/>
                                    <input type="hidden" value="<?php echo $applicant_info->PROGRAM_ID; ?>" name="txtProgram" id="txtProgram"/>
                                    <input type="hidden" value="<?php echo $applicant_info->SESSION_ID; ?>" name="txtSession" id="txtSession"/>
                                    <input type="hidden" value="<?php echo $SEMESTER_ID; ?>" name="txtSemister" id="txtSemister"/>
                                    <?php
                                }
                                ?>
                            </div>
                        ...
                        <table class="table invoice-total ">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-danger" id="due_amt"></td>
                                </tr>
                                <tr>
                                    <td><strong>Payment :</strong></td>
                                    <td class="text-danger" style="background-color:#F3F3F4;">
                                        <input type="text" name="txtPayment[]" class="required" required="required"  id="txtPayment" placeholder="00.00" style="width:80px; text-align:right;"/>
                                    </td>
                                </tr>
                                <tr>
        ...
        $(document).on("change", "#cmbSemester", function() {
            ...
            if (semester != "") {
                ...
                if (semester == "all") {
                    ...
                    $.ajax({
                        type: "post",
                        url: "<?php echo site_url('payment/getExpenseDetailsBySemester'); ?>/",
                        data: {
                            semester: semester,
                            txtStudent: txtStudent,
                            txtFaculty: txtFaculty,
