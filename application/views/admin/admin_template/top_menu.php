    ...
    <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right" style="margin-top: 15px">
                <li >
                    <span
                    class="m-r-sm text-muted welcome-message"><strong>Welcome,</strong> <?php $emp_details=$this->utilities->findByAttribute('hr_emp',array('EMP_ID'=>$user_session["EMP_ID"])); echo $emp_details->FULL_ENAME; ?>
                ...
                <li>
                    ...
                    data-target="#applicant_modal"><i class="fa fa-user"></i> Profile</a></li>
                       ...
                       <li><a title="Change Password" class="openModal"data-action="admin/resetPasswordInsert"><i class="fa fa-key"></i>  Change Password </a></li>
