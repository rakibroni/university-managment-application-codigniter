<div class="block-flat">
    ...
    <div class="form-group">
        <div class="col-lg-offset-2 col-lg-10">
            ...
            if ($ac_type == 2) {
                ?>
                <span class="btn btn-primary btn-sm formSubmit" data-action="course/updateDepWiseCourse"
                data-su-action="course/courseDepWiseById">Update</span>
                <?php } else {
                    ?>
                    <input type="button" class="btn btn-primary btn-sm formSubmit" data-action="course/createDepWiseCourse"
                    data-su-action="course/getDepWiseCourses" data-type="list" value="submit">
                    <?php }
                    ?>
