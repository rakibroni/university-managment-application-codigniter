...
<head>
    ...
    <title>eUMS | Reset Password </title>
...
<div class="loginColumns animated fadeInDown">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <h3 class="font-bold" style="color: green">Reset Password</h3>
            ...
            <div class="ibox-content">
                ...
                <?php endif; ?>
                <form class="m-t" role="form" action="<?php echo base_url();?>auth/resetAdminPassword" method="post">
                    <input type="hidden" name="user_email" value="<?php echo $user_email; ?>">
                    <div class="form-group">
                        <input type="password" name="new_pass" value="<?php echo set_value('new_pass'); ?>"
