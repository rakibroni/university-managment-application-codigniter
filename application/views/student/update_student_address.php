...
<div class="ibox-title">
    ...
    <div class="ibox-tools">
        <span data-action="student/addressInfo" id="update_address_cancel_btn" class="btn btn-success btn-xs pull-right" title="Back to previous" student-data-id="<?php echo $student_id ?>" role="button"><i class="fa fa-mail-reply"></i> Back</span>
    </div>
</div>

<div class="ibox-content">
<form id="student_address_form" class="form-horizontal fContent"  method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="DIVISION_ID" id="DIVISION_ID" class="form-control" >
                            ...
                            <?php foreach ($division as $row): ?>
                                <option value="<?php echo $row->DIVISION_ID ?>" <?php if(!empty($local_present_adddress)) {echo ( $local_present_adddress->DIVISION_ID == $row->DIVISION_ID) ? 'selected' : set_value('DIVISION_ID');} ?>><?php echo $row->DIVISION_ENAME ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="col-md-2">
                        <i class="fa fa-info-circle pointer2" data-content="Select division name"
                           ...
                           data-original-title="" title="Select division"></i>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="DISTRICT_ID" id="DISTRICT_ID" class="form-control" >
                            ...
                            <?php foreach ($district as $row): ?>
                                <option value="<?php echo $row->DISTRICT_ID ?>" <?php if(!empty($local_present_adddress)) {echo( $local_present_adddress->DISTRICT_ID == $row->DISTRICT_ID) ? 'selected' : set_value('DISTRICT_ID');} ?>><?php echo $row->DISTRICT_ENAME ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <i class="fa fa-info-circle pointer2" data-content="Select district name"
                           data-placement="right" data-toggle="popover" data-container="body"
                           data-original-title="" title="Select district"></i>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="THANA_ID" id="THANA_ID" class="form-control" >
                            ...
                            <?php foreach ($thana as $row): ?>
                                <option value="<?php echo $row->THANA_ID ?>" <?php if(!empty($local_present_adddress))  {echo ( $local_present_adddress->THANA_ID == $row->THANA_ID) ? 'selected' : set_value('THANA_ID');} ?>><?php echo $row->THANA_ENAME ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <i class="fa fa-info-circle pointer2" data-content="Select upazila or thana name"
                           data-placement="right" data-toggle="popover" data-container="body"
                           data-original-title="" title="Select upazila/thana"></i>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="POLICE_STATION_ID" id="POLICE_STATION_ID" class="form-control">
                            ...
                            <?php foreach ($police_station as $row): ?>
                                <option value="<?php echo $row->POLICE_STATION_ID ?>" <?php if(!empty($local_present_adddress)) {echo ( $local_present_adddress->POLICE_STATION_ID == $row->POLICE_STATION_ID) ? 'selected' : set_value('POLICE_STATION_ID');} ?>><?php echo $row->PS_ENAME ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <i class="fa fa-info-circle pointer2" data-content="Select police station"
                           data-placement="right" data-toggle="popover" data-container="body"
                           data-original-title="" title="Select police station"></i>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="UNION_ID" id="UNION_ID" class="form-control" >
                            ...
                            <?php foreach ($ward_no as $row): ?>
                                <option value="<?php echo $row->UNION_ID ?>" <?php if(!empty($local_present_adddress)) {echo ( $local_present_adddress->UNION_ID == $row->UNION_ID) ? 'selected' : set_value('UNION_ID');} ?>><?php echo $row->UNION_NAME ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <i class="fa fa-info-circle pointer2" data-content="Select ward or union"
                           data-placement="right" data-toggle="popover" data-container="body"
                           data-original-title="" title="Select union/ward no."></i>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="POST_OFFICE_ID" id="POST_OFFICE_ID" class="form-control">
                            ...
                            <?php foreach ($post_office as $row): ?>
                                <option value="<?php echo $row->POST_OFFICE_ID ?>" <?php if(!empty($local_present_adddress)) {echo ( $local_present_adddress->POST_OFFICE_ID == $row->POST_OFFICE_ID) ? 'selected' : set_value('POST_OFFICE_ID');} ?>><?php echo $row->POST_OFFICE_ENAME ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <i class="fa fa-info-circle pointer2" data-content="Select post office"
                           data-placement="right" data-toggle="popover" data-container="body"
                           data-original-title="" title="Select post office"></i>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" name="VILLAGE" id="VILLAGE" value="<?php if(!empty($local_present_adddress)) {echo $local_present_adddress->VILLAGE_WARD;} ?>" class="form-control"/>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="radio" name="same_as_present" class="same_as_present"
                               value="YES" <?php if(!empty($local_present_adddress)) {echo ($local_present_adddress->SAS_PSORPR == 'PS') ?  "checked" : "" ;}  ?>  >&nbsp; Yes &nbsp;
                        <input type="radio" name="same_as_present" class="same_as_present"
                               value="NO" <?php if(!empty($local_present_adddress)) {echo ($local_present_adddress->SAS_PSORPR == '') ?  "checked" : "" ;}  ?> >&nbsp; No &nbsp;
                ...
                <?php if($local_present_adddress->SAS_PSORPR == '') : ?>
                    ...
                    <div id="permanent_address">
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select name="P_DIVISION_ID" id="P_DIVISION_ID" class="form-control ">
                                    <option value="">-Select-</option>
                                    <?php foreach ($division as $row): ?>
                                        <option value="<?php echo $row->DIVISION_ID ?>" <?php if(!empty($local_permanent_adddress)) {echo ( $local_permanent_adddress->DIVISION_ID == $row->DIVISION_ID) ? 'selected' : set_value('DIVISION_ID');} ?>><?php echo $row->DIVISION_ENAME ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select name="P_DISTRICT_ID" id="P_DISTRICT_ID" class="form-control ">
                                    <option value="">-Select-</option>
                                    <?php foreach ($district as $row): ?>
                                        <option value="<?php echo $row->DISTRICT_ID ?>" <?php if(!empty($local_permanent_adddress)) {echo ( $local_permanent_adddress->DISTRICT_ID == $row->DISTRICT_ID) ? 'selected' : set_value('DISTRICT_ID');} ?>><?php echo $row->DISTRICT_ENAME ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select name="P_THANA_ID" id="P_THANA_ID" class="form-control ">
                                    <option value="">-Select-</option>
                                    <?php foreach ($thana as $row): ?>
                                        <option value="<?php echo $row->THANA_ID ?>" <?php if(!empty($local_permanent_adddress)) {echo ( $local_permanent_adddress->THANA_ID == $row->THANA_ID) ? 'selected' : set_value('THANA_ID');} ?>><?php echo $row->THANA_ENAME ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select name="P_POLICE_STATION_ID" id="P_POLICE_STATION_ID"
                                    ...
                                    <option value="">-Select-</option>
                                    <?php foreach ($police_station as $row): ?>
                                        <option value="<?php echo $row->POLICE_STATION_ID ?>" <?php if(!empty($local_permanent_adddress)) {echo ( $local_permanent_adddress->POLICE_STATION_ID == $row->POLICE_STATION_ID) ? 'selected' : set_value('POLICE_STATION_ID');} ?>><?php echo $row->PS_ENAME ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select name="P_UNION_ID" id="P_UNION_ID" class="form-control ">
                                    <option value="">-Select-</option>
                                    <?php foreach ($ward_no as $row): ?>
                                        <option value="<?php echo $row->UNION_ID ?>" <?php if(!empty($local_permanent_adddress)) {echo ( $local_permanent_adddress->UNION_ID == $row->UNION_ID) ? 'selected' : set_value('UNION_ID');} ?>><?php echo $row->UNION_NAME ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <select name="P_POST_OFFICE_ID" id="P_POST_OFFICE_ID" class="form-control">
                                    <option value="">-Select-</option>
                                    <?php foreach ($post_office as $row): ?>
                                        <option value="<?php echo $row->POST_OFFICE_ID ?>" <?php if(!empty($local_permanent_adddress)) {echo ( $local_permanent_adddress->POST_OFFICE_ID == $row->POST_OFFICE_ID) ? 'selected' : set_value('POST_OFFICE_ID');} ?>><?php echo $row->POST_OFFICE_ENAME ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="P_VILLAGE" id="P_VILLAGE" value="<?php if(!empty($local_permanent_adddress)) {echo $local_permanent_adddress->VILLAGE_WARD;} ?>" class="form-control "/>
                            </div>
                            <div class="col-md-2">
                                <i class="fa fa-info-circle pointer2"
                                   data-content="Enter your village,house or road no here" data-placement="right"
                ...
                <?php elseif ($local_present_adddress->SAS_PSORPR == 'PS') : ?>
                    ...
                    <div id="permanent_address">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="P_VILLAGE" id="P_VILLAGE" value="<?php if(!empty($local_present_adddress)) {echo $local_present_adddress->VILLAGE_WARD;} ?>" class="form-control "/>
                            </div>
                            <div class="col-md-2">
                                <i class="fa fa-info-circle pointer2"
                                   data-content="Enter your village,house or road no here" data-placement="right"
    ...
    <div class="form-group">
        <div class="col-md-4  pull-right">
            <input type="button" class="btn btn-primary btn-sm fSubmit pull-right" data-action="student/updateStudentAddressInfo"
                   data-su-action="student/addressInfo" data-param="<?php echo $student_id; ?>" value="Update">
        </div>
    </div>
</form>
</div>
