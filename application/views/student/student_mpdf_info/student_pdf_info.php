...
<body>
    <div id="printablediv" class="ibox-content">
        <div style="width: 100%;border-bottom: 2px solid black;">
            ...
            <h4 style="width:100%;text-align:center; margin:10px 0 -10 0; line-height:18px;"><?php echo ($student_info->FULL_NAME_EN !='') ? "$student_info->FULL_NAME_EN" : ""; ?> Profile</h4>
            <div class="row">
                ...
                <table class="table table-bordered">    
                    <tr>
                        ...
                        <td><b>: </b> </td>
                        <td><span><?php echo ($student_info->FULL_NAME_EN != '') ? " $student_info->FULL_NAME_EN " : "" ?></span>  </td> 
                     ...
                     <tr>
                        ...
                        <td><b>: </b> </td>
                        <td><span style="font-family:nikosh;"><?php echo ($student_info->FULL_NAME_BN != '') ? " $student_info->FULL_NAME_BN " : "" ?></span></td>
                    </tr>
                    <tr>
                        <td style="" ><b>Program  </b></td>
                        <td ><b>: </b> </td>
                        <td><span><?php echo $student_info->PROGRAM_NAME; ?></span></td>
                    </tr>
                    <tr>
                        <td><b>Mobile No. </b> </td>
                        <td><b>: </b> </td>
                        <td> <span><?php echo $student_info->MOBILE_NO; ?></span></td>
                    </tr>
                    <tr>
                        <td><b>Gender  </b> </td>
                        <td><b>: </b> </td>
                        <td><span><?php if ($student_info->GENDER == 'M') {
                            echo "Male"; }
                            elseif ($student_info->GENDER == "F") {
                            echo "Female";
                        }else{
                        echo "Others";
                    }
                ...
                <tr>
                    ...
                    <td><b>: </b> </td>
                    <td> <span><?php echo date('Y-m-d', strtotime($student_info->DATH_OF_BIRTH)) ?></span> </td> 
                </tr>
                <tr>
                    <td><b>Email  </b> </td>
                    <td><b>: </b> </td>
                    <td><span><?php echo $student_info->EMAIL_ADRESS; ?></span></td>
                ...
                <tr>
                    ...
                    <td><b> : </b> </td>
                    <td><span><?php echo $student_info->PLACE_OF_BIRTH; ?></span></td>
                </tr>
                <tr>
                    <td><b>Blood Group</b> </td>
                    <td><b> : </b> </td>
                    <td><span><?php echo ($student_info->LKP_BLOOD_GROUP !='')? " $student_info->LKP_BLOOD_GROUP " :"" ?></span></td>
                    <td  style="padding-left: 150px;" rowspan="7">
                        <?php if(!empty($student_info->SIGNATURE_PHOTO)) { ?>
                        <div class="avatar-zone-sig">
                            <center> </center><?php $photo=($student_info->SIGNATURE_PHOTO !='')? "upload/student/signature/".$student_info->SIGNATURE_PHOTO : 'assets/img/default_sign.png' ?>
                ...
                <tr>
                  ...
                  <td><b> : </b> </td>
                  <td><span><?php echo ($student_info->LKP_MARITAL_STATUS !='')? " $student_info->LKP_MARITAL_STATUS " :"" ?></span></td>
              </tr>
              <tr> 
                <td><b>Religion  </b> </td>
                <td><b> : </b> </td>
                <td><span id="P_RELIGION_ID"><?php echo ($student_info->LKP_RELIGION != '') ? " $student_info->LKP_RELIGION " : "" ?></span></td>
            </tr> 
            <tr>
                <td><b>Birth Certificate </b> </td>
                <td><b> : </b> </td>
                <td><span id="P_BIRTH_CERTIFICATE"><?php echo ($student_info->BIRTH_CERTIFICATE !='')? " $student_info->BIRTH_CERTIFICATE " :"" ?></span></td>
            </tr>
            <tr>
                <td><b>National ID </b> </td>
                <td><b> : </b> </td>
                <td><span id="P_NATIONAL_ID"><?php echo ($student_info->NATIONAL_ID !='')? " $student_info->NATIONAL_ID " :"" ?></span></td>
            </tr>
            <tr>
                <td><b>Height  </b> </td>
                <td><b> : </b> </td>
                <td><span id="P_HEIGHT_FEET"> <?php echo ($student_info->HEIGHT_FEET !='')? " $student_info->HEIGHT_FEET Feet" :"";?></td>
                </tr>
                <tr>
                    <td><b>Weight  </b> </td>
                    <td><b>: </b> </td>
                    <td><span id="P_WEIGHT_KG"> <?php echo ($student_info->WEIGHT_KG !='')? " $student_info->WEIGHT_KG Kg." :"" ?> </span></td>
                </tr>
            </table>
...
<div class="row">
    <p class="info" style="padding:3px 0px 3px 10px;"><b>Institute Information</b></p> 
    <table class="table table-bordered">
        <tr>
            <td><b>Admission Session</b></td>
            <td><b> : </b></td>
            <td><span id="P_ANNUAL_INCOME"></span><?php  echo ($student_info->adm_session_name != '') ? " $student_info->adm_session_name " : "" ?></td>
        </tr>
        <tr>
            <td><b>Current Session</b></td>
            <td><b> : </b></td>
            <td><span id="P_SCHOLARSHIP"><?php echo ($student_info->current_session_name != '') ? " $student_info->current_session_name " : "" ?></span></td>
        </tr>
        <tr>
            <td><b>Faculty Name</b></td>
            <td><b> : </b></td>
            <td><span id="P_EXPELLED"><?php  echo ($student_info->FACULTY_NAME != '') ? " $student_info->FACULTY_NAME " : "" ?></span></td>
        </tr>
        <tr>
            <td><b>Department Name</b></td>
            <td><b> : </b></td>
            <td><span id="P_ARRESTED"><?php echo ($student_info->DEPT_NAME != '') ? " $student_info->DEPT_NAME " : "" ?></span></td>
        </tr>
        <tr>
            <td><b>Program Name</b></td>
            <td><b> : </b></td>
            <td><span id="P_ARRESTED_DESC"><?php echo ($student_info->PROGRAM_NAME != '') ? " $student_info->PROGRAM_NAME " : "" ?></span></td>
        </tr>
        <tr>
            <td><b>Batch Name</b></td>
            <td><b> : </b></td>
            <td><span id="P_CONVICTED"><?php echo ($student_info->BATCH_TITLE != '') ? " $student_info->BATCH_TITLE " : "" ?></span></td>
        </tr>
        <tr>
            <td><b>Section</b></td>
            <td><b> : </b></td>
            <td><span id="P_APPLY_BEFORE"><?php echo ($student_info->section_name != '') ? " $student_info->section_name " : "" ?></span></td>
        </tr>
    </table>
</div>
<div class="row">
   <p class="info" style="padding:3px 0px 3px 10px;"><b>Waiver Information</b></p>
   <div class="ibox-content">
    <?php if (!empty($waiver_info)) { ?>
    <div class="table-responsive contentArea">
        <table class="table table-striped table-bordered table-hover" width="100%" style="border: 1px solid #C0C0C0; text-align: center;
        padding: 8px;">
        <tr class="info">
        ...
        <tbody>
            <?php $sl = 0;
            foreach ($waiver_info as $row): $sl++; ?>
            <tr>
                <td><?php echo $sl; ?></td>
                <td><?php if (!empty($row->SESSION_NAME)) {
                    echo $row->SESSION_NAME;
                } else {
                echo 'Session Name';
            } ?></td>
            <td><?php if (!empty($row->WAIVER_NAME)) {
                echo $row->WAIVER_NAME;
            } ?></td>
            <td> <?php if (!empty($row->PERCENTAGE)) {
                echo $row->PERCENTAGE . '%';
            } ?></td>
            <td><?php echo ($row->ACTIVE_STATUS == '1') ? 'Active' : ''; ?></td>
        </tr>
    <?php endforeach; ?>
