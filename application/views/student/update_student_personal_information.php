...
<div class="ibox-title">
    ...
    <div class="ibox-tools">
        <span data-action="student/personalDetails" id="update_personal_cancel_btn" title="Back to previous"
...
<form id="student_personal_form" class="form-horizontal fContent"  method="post" enctype="multipart/form-data">
    ...
    <div class="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" name="FULL_NAME_BN" id="FULL_NAME_BN"
                               value="<?php echo $student_info->FULL_NAME_BN; ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" name="PLACE_OF_BIRTH" id="PLACE_OF_BIRTH"
                               class="form-control" value="<?php echo $student_info->PLACE_OF_BIRTH; ?>"
                    ...
                    <div class="col-md-5">
                        ...
                        <select id="BLOOD_GRP" name="BLOOD_GRP" class="form-control">
                            ...
                            <?php foreach ($blood_group as $row): ?>
                                <option value="<?php echo $row->LKP_ID ?>" <?php echo ($student_info->BLOOD_GROUP == $row->LKP_ID) ? 'selected' : set_value('BLOOD_GRP') ?>><?php echo $row->LKP_NAME ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-md-5">
                        <select class="form-control" name="MARITAL_STATUS" id="MARITAL_STATUS">
                            ...
                            <?php foreach ($merital_status as $row): ?>
                                <option value="<?php echo $row->LKP_ID ?>" <?php echo ($student_info->MARITAL_STATUS == $row->LKP_ID) ? 'selected' : set_value('MARITAL_STATUS') ?>><?php echo $row->LKP_NAME ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-md-5">
                        <select class="form-control" name="NATIONALITY" id="NATIONALITY">
                            ...
                            <?php foreach ($nationality as $row): ?>
                                <option value="<?php echo $row->id ?>" <?php echo ($student_info->NATIONALITY == $row->id) ? 'selected' : set_value('NATIONALITY') ?>><?php echo $row->nationality ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" name="NATIONAL_ID" id="NATIONAL_ID"
                               value="<?php  echo $student_info->NATIONAL_ID; ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" name="BIRTH_CERTIFICATE" id="BIRTH_CERTIFICATE"
                               value="<?php echo $student_info->BIRTH_CERTIFICATE; ?>"
                    ...
                    <div class="col-md-5">
                        <select class="form-control" name="RELIGION_ID" id="RELIGION_ID">
                            ...
                            <?php foreach ($religion as $row): ?>
                                <option value="<?php echo $row->LKP_ID ?>" <?php echo ($student_info->RELIGION_ID == $row->LKP_ID) ? 'selected' : set_value('RELIGION_ID') ?>><?php echo $row->LKP_NAME ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-1" style="padding-right: 0;">
                        <input type="text" name="HEIGHT_FEET" id="HEIGHT_FEET"
                               value="<?php echo $student_info->HEIGHT_FEET; ?>" class="form-control numbersOnly"
                               placeholder="e.g: 5.8">
                    </div>
                    <div class="col-md-1">
                        Ft.
                    ...
                    <div class="col-md-1" style="padding-right: 0;">
                        <input type="text" name="HEIGHT_CM" id="HEIGHT_CM"
                               value="<?php echo $student_info->HEIGHT_CM; ?>" class="form-control numbersOnly"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-1" style="padding-right: 0;">
                        <input type="text" name="WEIGHT_KG" id="WEIGHT_KG"
                               value="<?php echo $student_info->WEIGHT_KG; ?>"
                    ...
                    <div class="col-md-2" style="padding-right: 0;">
                        <input type="text" name="WEIGHT_LBS" id="WEIGHT_LBS"
                               value="<?php echo $student_info->WEIGHT_LBS; ?>"
                               class="form-control numbersOnly" placeholder="Weight">
                    </div>
                    <div class="col-md-1">
                        Pound
                    ...
                    <div class="form-group col-md-12">
                        <div class="col-md-3">
                            <div class="avatar-zone">
                                <?php $photo = ($student_info->PHOTO != '') ? "upload/student/photo/" . $student_info->PHOTO. "?". rand() : 'assets/img/default.png' ?>
                    ...
                    <div class="form-group col-md-12">
                        <div class="col-md-3">
                            <div class="avatar-zone-sig">
                                <?php $sign = ($student_info->SIGNATURE_PHOTO != '') ? "upload/student/signature/" . $student_info->SIGNATURE_PHOTO : 'upload/default/default_sign.png' ?>
        ...
        <div class="form-group">
            <div class="col-md-4  pull-right">
                <input  type="button" class="btn btn-primary btn-sm fSubmit pull-right" data-action="student/updateStudentPersonalDetails"
                       data-su-action="student/personalDetails" data-param="<?php echo $student_id; ?>" value="Update">
            </div>
        </div>
    </div>
</form>
...
<script>
    ...
    $("#student_personal_form").validate({
        rules: {
                ...
                reader.onload = function (e) {
                    ...
                    image.onload = function () {
                        if (image.height > 300 && image.width > 300) {
                            ...
                            $('#student_pro_pic').attr('src', e.target.result);
