<div class="ibox-title">
    ...
    <?php // if ($applicant_info->ELIGIBLE_BY_ADDMISSION_DEPT_STATUS != 1) : ?>
        <div class="ibox-tools">
                            <span id="update_academic_btn" title="Update Academic Info" class="btn btn-success btn-xs pull-right"
                                  data-action="student/updateStudentAcademicInfo/<?php echo $student_id; ?>"><i class="fa fa-edit"></i> Edit </span>
        </div>
    <?php // endif; ?>
</div>
