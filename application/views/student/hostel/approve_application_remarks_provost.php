    ...
    <form id="resident_application_remark_form" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8"> 
                    <textarea name="REMARK_PROVOST" class="form-control" rows="5" > </textarea>  
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5"> 
                   <select class="form-control" name="APPROVE_PROVOST_STATUS"  >
             ...
             <div class="form-group">
                ...
                <div class="col-lg-10"> 
                     <input type="button" class="btn btn-primary btn-sm form_submit" data-action="teacher/saveResidentAppAprvByProvost"
