...
<div class="">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>Existing Students Insert form</h5>
        </div>
        <form id="existingStu" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            <div class="">
                <div class="ibox-content">
                    ...
                    <div class="div-background">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="FULL_NAME_EN" id="FULL_NAME_EN"
                                           value="<?php echo $students_info->FULL_NAME_EN ?>" class="form-control"
                                           placeholder="Full Name In English" Readonly>
                            ...
                            <div class="form-group">
                                <label class="col-md-5 control-label">নাম ( বাংলা ) <span class="red">*</span></label>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" name="DATH_OF_BIRTH" id="DATH_OF_BIRTH"
                                               ...
                                               value="<?php echo set_value('DATH_OF_BIRTH'); ?>" required>
                            ...
                            <div class="form-group">
                                <label class="col-md-5 control-label">Place of Birth <span class="red">*</span></label>

                                <div class="col-md-5">
                                    <div class="input-group date">
                                        <input type="text" name="PLACE_OF_BIRTH" id="PLACE_OF_BIRTH"
                                               class="form-control" value="<?php echo set_value('PLACE_OF_BIRTH'); ?>"
                            ...
                            <div style="display:none" id="spouse_name">
                                <div class="form-group">
                                    <label class="col-md-5 control-label">Spouse Name <span class="red">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="" id="PHONE"
                                           value="<?php echo $students_info->CONTACTS; ?>"
                                           class="form-control numbersOnly" placeholder="Mobile" readonly>
                                    <span
                            ...
                            <div class="pull-right" style="margin-right: 60px">
                                <div class="form-group">
                                    <div class="col-md-3">
                                        ...
                                        <input type='file' id="propic" name="photo" onchange="upload_img(this);"
                                               class="upload_btn" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <span style="color:red;">
                                        ->Student,father,mother  photo format must be .gif, .jpg, .jpeg or .png<br>
                    ...
                    <div class="div-background">
                        ...
                        <div class="col-md-4">
                            <div class="pull-right" style="margin-right: 60px">
                                <div class="form-group">
                                    <div class="col-md-3">
                                        <div class="avatar-zone">
                                            <img id="f_img_id" src="<?php echo base_url('assets/img/default.png'); ?>"
                                                 alt="select photo" style="width: 180px;
                                                 height: 160px;" />
                                        </div>
                                        <div class="overlay-layer">Father photo</div>
                                        <input type='file' id="fatherpic" name="father_photo"
                                               onchange="upload_father_img(this);" class="upload_btn">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="pull-right" style="margin-right: 60px">
                                <div class="form-group">
                                    <div class="col-md-3">
                                        <div class="avatar-zone">
                                            <img id="m_img_id" src="<?php echo base_url('assets/img/default.png'); ?>"
                                                 alt="select photo" style="width: 180px;
                                                 height: 160px;" />
                                        </div>
                                        <div class="overlay-layer">Mother photo</div>
                                        <input type='file' id="motherpic" name="mother_photo"
                                               onchange="upload_mother_img(this);" class="upload_btn">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <input type="radio" class="SAS_PSORPR" name="SAS_PSORPR" value="1" id="PARM_ADDRESS_YES"
                                       checked>&nbsp; Yes
                            </div>
                            <div class="col-md-1">
                                <input type="radio" class="SAS_PSORPR" name="SAS_PSORPR" value="0" id="PARM_ADDRESS_NO">&nbsp;
                                No
                            </div>
                            <div class="col-md-1">
                                <i class="fa fa-info-circle pointer2"
                        ...
                        <div id="permanent_address" class="toggle-div">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" name="P_VILLAGE" value="" class="form-control is_required" />
                                </div>
                                <div class="col-md-3">
                                    <i class="fa fa-info-circle pointer2"
                                       data-content="Enter your village,house or road no here" data-placement="right"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="text" name="LOCAL_GAR_PHN[]" id="LOCAL_GAR_PHN" value=""
                                           class="form-control is_required_o numbersOnly" placeholder="Mobile">
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="col-md-12">
                                <table id="academic_list" class="table table-bordered dataTable">
                                    ...
                                    <tr>
                                        ...
                                        <th width="25%" class="text-center"><span class="btn btn-xs btn-warning"
                                                                                  id="add_academic"><i
                            ...
                            <div class="col-md-2">
                                <div class="input-group date">
                                    ...
                                    <input type="text" readonly="" required="required" class="form-control datepicker"
                                           ...
                                           value="<?php echo set_value('ADMISSION_DATE'); ?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                    ...
                    <div class="div-background">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="FACULTY_C" id="FACULTY_C" required>
                                    <option value="">-Select-</option>
                                    <?php foreach ($faculty as $row) { ?>
                                        <option
                                            value="<?php echo $row->FACULTY_ID ?>"><?php echo $row->FACULTY_NAME ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                ...
                                <div id="offer_course_list_div" class="toggle-div-course flexy">
                                    <div id="offer_course_list">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <select class="form-control" name="SEMISTER_ID_C" id="SEMISTER_ID_C" required>
                                    <option value="">-Select-</option>
                                    <?php foreach ($semester as $row) { ?>
                                        <option value="<?php echo $row->LKP_ID ?>"><?php echo $row->LKP_NAME ?></option>
                                    <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <select class="form-control" name="SESSION_ID_C" id="SESSION_ID_C" required>
                                    <option value="">-Select-</option>
                                    <?php foreach ($session as $row) { ?>
                                        <option
                                            value="<?php echo $row->SESSION_ID ?>"><?php echo $row->SESSION_NAME ?></option>
                    ...
                    <div class="div-background">
                            ...
                            <?php foreach ($substance as $row): ?>
                                <tr>
                                    <td><input type="hidden" name="SUBSTANCE[]"
                                               value="<?php echo $row->LKP_ID ?>"><?php echo $row->LKP_NAME ?> </td>
                                    <td>
                                    ...
                                    <td><input type="text" name="TYPE_AMOUNT_FREQUENCY[]" class="form-control"></td>
                                    <td><input type="text" name="DURATION[]" class="form-control"></td>
                                    <td><input type="text" name="STOP_DT[]" class="form-control datepicker"></td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table>
                        <table id="disease_list" class="table table-bordered">
                            ...
                            <tbody>
                            <tr>
                                <td><input type="text" name="DISEASE_NAME[]" id="disease_name" class="form-control">
                                </td>
                                <td><input type="text" name="START_DT[]" id="disease_start_date"
                                           class="form-control datepicker"></td>
                                <td><input type="text" name="END_DT[]" id="disease_end_date"
                                           class="form-control datepicker"></td>
                                <td><input type="text" name="DOCTOR_NAME[]" id="doctor" class="form-control"></td>
                                <td>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input id="source" name="SSOF_FINANC" value="P" type="radio" checked>&nbsp;
                                            Parents
                                        </div>
                                        <div class="col-md-2">
                                            <input id="emergencyCon" name="SSOF_FINANC" value="S" type="radio">&nbsp;
                                            Self
                                        </div>
                                        <div class="col-md-2">
                                            <input id="emergencyCon" name="SSOF_FINANC" value="O" type="radio">&nbsp;
                                            Others
                                        </div>
                                        <div id="finance_guardian" style="display:none">
                                            <div class="col-md-2">
                                                <input id="emergencyCon" name="SSOF_FINANC" value="G" type="radio">&nbsp;
                                                Guardian
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1">
                                        <input id="siblin" name="SIBLING_EXIST" value="1" type="radio">&nbsp; Yes
                                    </div>
                                    <div class="col-md-1">
                                        <input id="siblin" name="SIBLING_EXIST" value="0" type="radio" checked>&nbsp; No
                                    </div>
