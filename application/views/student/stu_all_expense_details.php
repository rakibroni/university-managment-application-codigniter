        ...
        foreach ($expenses as $expense):
            ...
            <div class="ibox collapsed in">
                <div class="ibox-title" style="padding: 10px;">
                    <h5><?php echo $expense->LKP_NAME; ?> - <?php echo $expense->SESSION; ?></h5><br/>
                    ...
                    <div class="ibox-tools" data-toggle="tooltip" data-placement="right"
                ...
                <div class="ibox-content" style="display:block">
                    <ul class="todo-list m-t small-list" id="expenseList">
                        ...
                        if ($totalPayment < $sem_total) {
                            ...
                            ?>
                            <li style="border-top:1px solid #000; border-radius: 0; ">
                                <div class="pull-right" id="balance<?php echo $i; ?>"><span class="text-navy">Total Due = <strong
