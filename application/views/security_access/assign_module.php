                ...
                <div class="card">
                    <div class="card-body">
                        <ul id="tree_1" class="tree" style="padding: 5px;">
                            <li>
                                <a class="tree-toggle" href="#" data-role="branch" data-toggle="branch"
                                data-value="Bootstrap_Tree" style="float: left;"> Modules </a>
                                ...
                                <ul class="branch in" id="modules" style="width: 98%; padding: 5px; margin-left: 15px;">
                                    ...
                                    foreach ($org_modules as $org_module) {
                                        ...
                                        ?>
                                        <li>
                                            <a id="nut3" data-value="Bootstrap_Tree" data-toggle="branch"
                                            class="tree-toggle closed" href="#"
                                                    ...
                                                    <span style="color: #333;"><i
                                                        ...
                                                        <span style="float: right;">
                                                            <span style="padding: 0 17px;">
                                                                ...
                                                                <input type="checkbox" class="chkPage"
                                                                title="Create"
                                                            ...
                                                            <span style="padding: 0 17px;">
                                                                ...
                                                                <?php } else { ?>
                                                                <input type="checkbox" title="Read"
                                                                disabled="disabled"/>
                                                                <?php } ?>
                                                            </span>
                                                            <span style="padding: 0 17px;">
                                                                ...
                                                                <?php } else { ?>
                                                                <input type="checkbox" title="Update"
                                                                disabled="disabled"/>
                                                                <?php } ?>
                                                            </span>
                                                            <span style="padding: 0 17px;">
...
<script src="<?php echo base_url(); ?>assets/bootstrap-tree/bootstrap-tree/js/tree.js"></script>
        ...
        $(document).on("click", ".chkPageByUser", function () {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    is_checked: checked,
                    group_id: group,
                    sa_uglwm_link_id: sa_uglwm_link,
                    user: user_id,
                    level: level_id
                },
                success: function (result) {
