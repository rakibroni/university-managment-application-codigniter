...
<ul class="accessChart" style="display: none;">
    <li>
        <img alt="<?php echo $user_info->FULL_NAME; ?>" class="tooltips" data-placement="top"
             title="<?php echo $user_info->FULL_NAME; ?>" src="<?php echo base_url(); ?>resources/img/avatar-mini.png">
        <br/>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".orgChart table tbody > tr > td:first .node0").css({
            "backgroundColor": "#fff",
            "border": "0",
            "boxShadow": "none",
            "width": "200px"
