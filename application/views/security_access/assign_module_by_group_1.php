...
<div class="control-group">
    <div class="controls"
         style="padding-left: 1%; background: #f2f2f2; border-top:1px solid #e3e3e3; border-bottom:1px solid #e3e3e3;">
        <?php echo form_dropdown('cmbGroup', $groups, '', 'id="cmbGroup" aria-required="true" class="span2 chzn-select" tabindex="1"'); ?>
        <span class="getLevel"><select class="span2 chzn-select cmbLevel" id="cmbLevel" name="cmbLevel"
                                       data-placeholder="Choose a Level" tabindex="1">
...
<span class="span8" style="border: 1px solid #74B749; min-height: 200px; margin-bottom: 10px;">
    ...
    <ul id="tree_1" class="tree" style="margin-left: 7px;">
        <li>
            <a class="tree-toggle" href="#" data-role="branch" data-toggle="branch" data-value="Bootstrap_Tree">
                Modules </a>
            ...
            <ul class="branch in" id="modules" style="width: 98%;">
                ...
                foreach ($org_modules as $org_module) {
                    ...
                    ?>
                    <li>
                        <a id="nut3" data-value="Bootstrap_Tree" data-toggle="branch" class="tree-toggle closed"
                           href="#" style="color: #4A8BC2;"><?php echo $org_module->SA_MODULE_NAME; ?></a>
                        <ul class="branch">
                            <?php foreach ($org_module_links as $org_module_link): ?>
                                <li style="border-bottom: 1px dashed #ccc; padding: 0 0 5px 0; background: #f2f2f2; padding-left: 5px;">
                                    <a data-role="leaf" href="#">
                                        ...
                                        <input type="hidden" name="txtLinkId[]"
                                               value="<?php echo $org_module_link->LINK_ID; ?>"/>
                                        <input type="hidden" name="txtModuleId[]"
                                               value="<?php echo $org_module->SA_MODULE_ID; ?>"/>
                                    </a>
                                    <span style="float: right;">
            ...
            <table class="table">
                ...
                if (!empty($users)) {
                    foreach ($users as $user) {
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" name="chkUser" value="<?php echo $user->USER_ID; ?>"
                                       style="float: left;"/>&nbsp;&nbsp;
...
<link rel="stylesheet" type="text/css"
      href="<?php echo base_url(); ?>resources/assets/bootstrap-tree/bootstrap-tree/css/bootstrap-tree.css"/>
