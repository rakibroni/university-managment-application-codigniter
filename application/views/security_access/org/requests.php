...
<div class="widget fluid">
    <div class="whead"><h6>New Request For Care Provider Template</h6>

        <div class="clear"></div>
    </div>
    <div id="dyn2" class="shownpars">
        <a class="tOptions act" title="Options"><img src="<?php echo site_url(); ?>media/admin/images/icons/options.png"
                                                     alt=""/></a>
            ...
            foreach ($requests as $request) {
                ...
                <tr>
                    ...
                    <td><img style="width: 80px;"
                             src="<?php echo base_url(); ?>media/uploads/org_img/<?php echo $request->LOGO; ?>"
                             alt="<?php echo $request->ORG_NAME; ?>" title="<?php echo $request->ORG_NAME; ?>"/></td>
                    <td><?php echo $request->ORG_NAME; ?></td>
                    <td><?php echo $request->HC_NAME; ?></td>
                    <td><?php echo $request->LOOKUP_DATA_NAME; ?></td>
                    <td class="textCenter"><span title="Click here for Details" class="noOfBranch"
                                                 orgId="<?php echo $request->ORG_ID; ?>"><?php echo $request->NOOFBRANCH; ?></span>
                    </td>
                    <td class="textCenter"><i title="Send Mail" class="sendMail fa fa-envelope"
                                              orgId="<?php echo $request->ORG_ID; ?>"></i></td>
                </tr>
                <?php
                $i++;
            }
...
<script src="<?php echo base_url(); ?>media/doctor/js/jquery.dataTables.js" type="text/javascript"
