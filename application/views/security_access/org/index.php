                    ...
                    foreach ($careProviders as $careProvider) {
                        ...
                        <tr>
                            ...
                            <td><img style="width: 50px;"
                                     src="<?php echo base_url('upload/organization/logo/'.$careProvider->LOGO); ?>"
                                     alt="<?php echo $careProvider->ORG_NAME; ?>"
                                     title="<?php echo $careProvider->ORG_NAME; ?>"/></td>
                            <td><?php echo $careProvider->ORG_NAME; ?></td>
                            <td class="center">
                                <?php if ($careProvider->STATUS == '1') { ?>
                                    <span style="color:green; font-size: 25px;"
                                          data-hId="<?php echo $careProvider->ORG_ID; ?>"
                                          status="<?php echo $careProvider->STATUS; ?>" class="statusType"><i
                                            class="md md-check-box"></i></span>
                                <?php } else { ?>
                                    <span style="color:red; font-size: 25px;"
                                          data-hId="<?php echo $careProvider->ORG_ID; ?>"
                                          status="<?php echo $careProvider->STATUS; ?>" class="statusType"><i
                                            class="md-not-interested"></i></span>
                                <?php } ?>
                            </td>
                            <td class="center">
                                <a class="btn btn-danger create_group" data-toggle="modal" href="#modal_window"
                                   data-hid="<?php echo $careProvider->ORG_ID; ?>">Create Group</a>
                            </td>
                            <td class="center">
                                <button class="btn bgm-red addModule" data-hid="<?php echo $careProvider->ORG_ID; ?>"
                                        title="Assign Module">Create User
                                </button>
                            </td>
                            <td class="center" style="width: 140px;">
                                <a class="btn btn-danger addModule" data-toggle="modal" href="#modal_window"
                                   data-hid="<?php echo $careProvider->ORG_ID; ?>">Assign Module</a>
                            </td>
                            <td class="center">
                                <a class="btn btn-danger addLink" data-toggle="modal" href="#modal_window"
                                   data-hid="<?php echo $careProvider->ORG_ID; ?>">Add Pages</a>
                            </td>
                        </tr>
                        <?php
                        $i++;
