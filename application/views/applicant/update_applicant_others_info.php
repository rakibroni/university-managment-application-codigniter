...
<div class="ibox-title">
    ...
    <div class="ibox-tools">
        <span data-action="applicant/applicantOtherDetailsInfo" id="update_othersInfo_cancel_btn" class="btn btn-success btn-xs pull-right" applicant-data-id="<?php echo $applicant_info->APPLICANT_ID; ?>" role="button"><i class="fa fa-mail-reply"></i> Back</span>
    </div>
    <?php // endif; ?>
</div>
...
<div class="form-group">
    <div class="col-sm-3  pull-right">
        <input type="button" class="btn btn-primary btn-xs fSubmit pull-right" data-action="applicant/updateApplicantOtherDetailsInfo"
               data-su-action="applicant/applicantOtherDetailsInfo" value="Update">
