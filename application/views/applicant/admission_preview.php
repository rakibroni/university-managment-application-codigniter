<?php $applicant_ses=$this->session->userdata('applicant_logged_in');?>
<div class="ibox-content">
    <div class="row">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td><b>Admission Program </b> </td>
                    <td><b>: </b> </td>
                    <td> <?php echo $selected_program->PROGRAM_NAME;?></td>
                    <td rowspan="8">                   
                    <b>Photo :</b> 
                     <br><br>
                ...
                <tr>
                    ...
                    <td><b>: </b> </td>
                    <td> <?php echo $applicant_ses['FULL_NAME'] ;?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><b>Mobile No. </b> </td>
                    <td><b>: </b> </td>
                    <td> <?php echo  $applicant_ses['MOBILE']; ?></td>
                </tr>
                <tr>
                    <td><b>Gender  </b> </td>
                    <td><b>: </b> </td>
                    <td> <?php if($applicant_ses['GENDER'] =='M'){echo "Male";}else if($applicant_ses['GENDER'] =='F'){echo "Female";}else{ echo "Others";} ?></td>
                </tr>
                <tr>
                    <td><b>Date of Birth  </b> </td>
                    <td><b>: </b> </td>
                    <td> <?php echo date('d-M-Y',strtotime( $applicant_ses['BIRTH_DT'])) ?></td>
                </tr>
                <tr>
                    <td><b>Email  </b> </td>
                    <td><b>: </b> </td>
                    <td><?php echo  $applicant_ses['EMAIL'] ?></td>
                ...
                <tr>
                    ...
                    <input type='file' style="cursor: pointer;" name="photo" id="sigpic" onchange="upload_img_sig(this);" class="upload_btn"
                    >
                    </td>
                </tr>
                <tr>
