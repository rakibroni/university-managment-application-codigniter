    ...
    <div class="col-md-3">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                ...
                <img id="applicant_pro_pic" src="<?php echo base_url($photo); ?>" class="img-responsive" alt=""></div>
            ...
            <div class="profile-usermenu">
                <ul class="nav" id="navlist">
                    <li class="active">
                        <a id="personal_information" data-action="applicant/applicantPersonalDetails" href="#"> <i
                    ...
                    <li>
                        <a data-action="applicant/applicantFamillyDetails" href="#"> <i
                                    class="glyphicon glyphicon-user"></i>
                            Family
                        </a>
                    </li>
                    <li>
                        <a data-action="applicant/applicantAddressInfo" href="#"> <i
                                    class="glyphicon glyphicon-envelope"></i>
                            Postal Address
                        </a>
                    </li>
                    <li>
                        <a data-action="applicant/applicantAcademicInfo" href="#" target="_blank">
                            <i class="glyphicon glyphicon-book"></i>
                            Academic Info
                        </a>
                    </li>
                    <li>
                        <a data-action="applicant/applicantOtherDetailsInfo" href="#" target="_blank">
