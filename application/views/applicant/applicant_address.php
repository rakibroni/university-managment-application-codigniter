    ...
    <!-- <?php if ($applicant_info->ELIGIBLE_BY_ADDMISSION_DEPT_STATUS != 1) : ?>
        <div class="ibox-tools">
                            <span id="update_address_btn" title="Update Postal Address Info"
                                  ...
                                  data-action="applicant/updateApplicantAddressInfo"><i
    ...
    <div class="table-responsive contentArea">
        ...
        <?php if ($local_present_adddress->SAS_PSORPR != 'PS') { ?>
            <table width="50%" class="table table-striped table-bordered table-hover gridTable">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td class="col-lg-8"><?php if (!empty($local_permanent_adddress->DIVIS_NAME)) echo $local_permanent_adddress->DIVIS_NAME ?></td>
                </tr>
                <tr>
                    <th>District</th>
                    <td>:</td>
        ...
        <?php } else { ?>
            <table width="50%" class="table table-striped table-bordered table-hover gridTable">
                <tbody>
                <tr>
                    <th colspan="3"> Permanent Address: <?php echo "Same as Present Address"; ?></th>
                </tr>
