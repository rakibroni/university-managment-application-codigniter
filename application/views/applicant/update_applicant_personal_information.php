...
<div class="ibox-title">
    ...
    <div class="ibox-tools">
            ...
            <span data-action="applicant/applicantPersonalDetails" id="update_personal_cancel_btn"
            ...
            <div class="form-group">
                <div class="col-sm-3  pull-right">
                    <input type="button" class="btn btn-primary btn-xs fSubmit pull-right"
                           data-action="applicant/updateApplicantPersonalDetails"
                           data-su-action="applicant/applicantPersonalDetails" value="Update">
                </div>
            </div>
        </div>
    </form>
...
<script>
                ...
                reader.onload = function (e) {
                    ...
                    image.onload = function () {
                        if (image.height > 300 && image.width > 300) {
                            ...
                            $('#applicant_pro_pic').attr('src', e.target.result);
    ...
    $("#applicant_personal_form").validate({
        ...
        messages: {
            ...
            FULL_NAME_BN: "Full Bangla Name required",
            PLACE_OF_BIRTH: "Place of birth required",
