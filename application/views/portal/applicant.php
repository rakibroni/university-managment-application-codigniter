    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <?php foreach ($degree as $row): ?>
                <p style="color: inherit;"><a
                        href="<?php echo base_url() ?>Portal/portalDegree/<?php echo $row->DEGREE_ID; ?>"><i
                            class="fa fa-caret-right"></i> &nbsp;<?php echo $row->DEGREE_NAME; ?></a></p>
                <!-- <p style="color: inherit;"><a class="openBigModal" title="Program list accourding to Department" id="<?php echo $row->DEPT_ID; ?>" data-action="portal/portalProg" data-type="edit"><i class="fa fa-caret-right"></i> &nbsp;<?php echo $row->DEPT_NAME; ?></a></p> -->
            <?php endforeach; ?>
        </div>
        <div class="col-sm-3">
            ...
            <p><a class="navy-link" href="landing.html#" role="button">Details &raquo;</a></p>
        </div>
        <div class="col-sm-3">
...
<section class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="<?php echo base_url(); ?>assets/img/landing/perspective.png" alt="dashboard"
    ...
    <div class="row features-block">
        <div class="col-lg-6 features-text wow fadeInLeft">
            ...
            <a href="landing.html" class="btn btn-primary">Learn more</a>
        </div>
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="<?php echo base_url(); ?>assets/img/landing/dashboard.png" alt="dashboard"
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="<?php echo base_url(); ?>assets/img/landing/avatar3.jpg"
                    ...
                    <ul class="list-inline social-icon">
                        <li><a href="landing.html#"><i class="fa fa-twitter"></i></a>
                        </li>
                        <li><a href="landing.html#"><i class="fa fa-facebook"></i></a>
                        </li>
                        <li><a href="landing.html#"><i class="fa fa-linkedin"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="<?php echo base_url(); ?>assets/img/landing/avatar1.jpg" class="img-responsive img-circle"
                         alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="<?php echo base_url(); ?>assets/img/landing/avatar2.jpg"
                         class="img-responsive img-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="<?php echo base_url(); ?>assets/img/landing/iphone.jpg" class="img-responsive"
                     alt="dashboard">
            </div>
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="landing.html" class="pull-left">
        ...
        <div class="row">
            <div class="col-lg-4 wow zoomIn">
                <ul class="pricing-plan list-unstyled">
                    ...
                    <li>
                        <a class="btn btn-primary btn-xs" href="landing.html#">Signup</a>
                    </li>
                </ul>
            </div>
