                ...
                <div class="ibox-content mailbox-content">
                    <div class="file-manager">
                        ...
                        <ul class="folder-list m-b-md padding_0">
                            <?php
                            $facultyList = $this->utilities->findAllByAttribute('faculty', array('ACTIVE_STATUS' => 1));
                            foreach ($facultyList as $facultyInfo) {
                                ?>
                                <li><a href="#"><span class="deg_link pointer"
                                                      id="<?php echo $facultyInfo->FACULTY_ID; ?>"><i
                                                class="fa fa-graduation-cap "></i> <?php echo $facultyInfo->FACULTY_NAME; ?></span></a>
                                </li>
                            <?php
                            }
                            ?>
        ...
        <div class="col-lg-8 animated fadeInRight">
            ...
            <div class="mail-box">
                <table class="table table-hover table-mail">
                    ...
                    <?php
                    $programList = $this->utilities->findAllByAttribute('program', array('FACULTY_ID' => $faculty_id));
