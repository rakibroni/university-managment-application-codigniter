...
<body>
<div id="wrapper">
    <?php $this->load->view("applicant_portal/navbar"); ?>
    <div id="page-wrapper" class="gray-bg">
        <?php $this->load->view("applicant_portal/top_menu"); ?>
    ...
    <?php $this->load->view("applicant_portal/theme_settings"); ?>
</div>
<?php $this->load->view("applicant/common/applicant_common_js.php"); ?>
