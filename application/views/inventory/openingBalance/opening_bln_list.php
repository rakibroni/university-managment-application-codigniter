        ...
        <?php if (!empty($item_info)): ?>
            ...
            <tr class="gradeX" id="row_<?php echo $row->STOCK_ID; ?>">
                <td <?php echo ($row->ACTIVE_STATUS == 1) ? "" : "class='inactive'"; ?>>
                    ...
                    id="loader_<?php echo $row->STOCK_ID; ?>"></span></td>
                    ...
                    <td <?php echo ($row->ACTIVE_STATUS == 1) ? "" : "class='inactive'"; ?>>
                        ...
                        <a class="label label-default openModal" id="<?php echo $row->STOCK_ID; ?>"
                         title="Update Opening Balance Information" data-action="inventory/openingBlnFormUpdate"
                         data-type="edit"><i class="fa fa-pencil"></i></a>
                         <?php
                     }
                     if ($previlages->DELETE == 1) {
                        ?>
                        <a class="label label-danger deleteItem" id="<?php echo $row->STOCK_ID; ?>"
                         title="Click For Delete" data-type="delete" data-field="STOCK_ID" data-tbl="inv_stock"><i
                     ...
                     if ($previlages->STATUS == 1) {
                        ?>
                        <a class="itemStatus" id="<?php echo $row->STOCK_ID; ?>"
                         data-status="<?php echo $row->ACTIVE_STATUS ?>" data-fieldId="STOCK_ID"
                         data-field="ACTIVE_STATUS" data-tbl="inv_stock" data-su-url="inventory/openingBlnById">
