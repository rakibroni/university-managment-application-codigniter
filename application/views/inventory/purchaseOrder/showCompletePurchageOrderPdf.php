...
<div style="width: 100%;border-bottom: 2px solid black;">
    ...
    <h4 style="width:100%;text-align:center; margin:10px 0 0 0; line-height:18px;">Completed Purchase Order</h4>

    <div class="row">
      <p class="info" style="padding:3px 0px 3px 10px;"><b>Purchase Order Details Info</b></p>
                     ...
                     <?php foreach ($poDetails as $key => $value) {
                        ...
                        <tr>
                         ...
                         <td class="col-sm-2" align="center">
                            ...
                            ?>
                            <?php echo $reQ->TOTAL_RECEIVE_QTY; ?> (<?php echo $value->UNIT_NAME; ?>)
                        </td>
                        <td class="col-sm-5">
