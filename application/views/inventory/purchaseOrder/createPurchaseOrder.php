<div class="block-flat">
    <form class="form-horizontal frmContent" id="inventory" method="post" action="<?php echo base_url('inventory/savePurchaseOrder') ?>">
                ...
                <div id="" class="panel-collapse collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <table class="table table-bordered">
                            <tr class="info">
                                <td colspan="6"><b class="text-warning">Purchase Order Details Info</b></td>
                            </tr>
                            <tr>
                                <th>Purchase Date</th>
                                <th>:</th>
                                <td>
                                    <input type="text" required="required" class="datepicker form-control" name="PO_DATE"></td>
                                    <th>Remarks</th>
                                    <th>:</th>
                                    <td>
                        ...
                        <div class="panel-body">
                          <table id="myTable" class=" table order-list">                       
                            <tbody>
                                ...
                                <td class="col-sm-3">
                                    <input type="text" name="ORDER_QTY[]" id="ORDER_QTY" required="required"  class="form-control text-center"/>
                                </td>
                                <td class="col-sm-5">
...
<script>
   $(document).ready(function () {
    ...
    $("#addrow").on("click", function () {
        var newRow = $("<tr>");
        var cols = "";
        cols += '<td><select class="form-control" required="required" name="ITEM_ID[]" id="ITEM_ID_' + counter + '"  >' +
        '<option value="">--Select--</option>' +
