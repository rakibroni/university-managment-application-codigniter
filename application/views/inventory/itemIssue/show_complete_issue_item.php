        ...
        <div id="" class="panel-collapse collapse in" aria-expanded="true">
            <div class="panel-body">
               <table id="" border="1" rules="all" class="table table-striped table-bordered table-hover printable table-sm no-footer centered" cellspacing="0" width="100%" role="grid">
                    ...
                    <tr>
                        <td>Remarks</td>
                        <td><?php echo $mst_data_info->REMARKS;?></td>                       
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class="panel-body">
              <!--  <table id="myTable" class="table order-list"> -->
                ...
                <tbody>
                    ...
                    <td class="col-sm-2">
                        <input style="text-align: center;" type="text" name="STOCK[]" value="" class="form-control cursor-not-allow"/>
                    </td>
                  ...
                  <!--  <td>
                        ...
                        if($demand == $toIsseQ){
                           ?>
                          <input readonly="readonly"  style="text-align: center; background-color: #ccf5ff;" type="text" name="" class="form-control getIssueQty"/>
                           <?php }else{?>
                           <input required="required" style="text-align: center;" type="text" name="ISSUED_QTY[]" class="form-control getIssueQty"/>
                           <?php }
                           ?>
                       </td>-->
...
<center>
 <a class="btn btn-primary" target="_blank" href="<?php echo base_url();?>/inventory/issueItemPdf/<?php echo $req_row->REQ_MST_ID ?>">Print
                            </a>
