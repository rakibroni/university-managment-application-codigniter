    ...
    <div class="col-md-3">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                <?php $photo = ($applicant_info->PHOTO != '') ? "upload/applicant/photo/" . $applicant_info->PHOTO : 'assets/img/default.png' ?>
            ...
            <div class="profile-usermenu">
                <ul class="nav" id="navlist">
                    <li class="active">
                        <a id="personal_information" data-action="eregistration/registrationPersonalDetails" href="#"> <i
                                class="glyphicon glyphicon-home"></i>
                            Personal Info
                        </a>
                        <!--                        <a class="label label-default openModal" id=""-->
                        <!--                           data-action="setup/departmentFormUpdate"></a>-->
                    </li>
                    <li>
                        <a data-action="eregistration/registrationFamilyDetails" href="#"> <i
                                class="glyphicon glyphicon-user"></i>
                            Family
                        </a>
                    </li>
                    <li>
                        <a data-action="eregistration/registrationAddressInfo" href="#"> <i
                                class="glyphicon glyphicon-envelope"></i>
                            Postal Address
                        </a>
                    </li>
                    <li>
                        <a data-action="eregistration/registrationAcademicInfo" href="#" target="_blank">
                            <i class="glyphicon glyphicon-book"></i>
                            Academic Info
                        </a>
                    </li>
                    <li>
                        <a data-action="eregistration/registrationOtherDetailsInfo" href="#" target="_blank">
                ...
                <?php if ($applicant_info->ELIGIBLE_BY_ADDMISSION_DEPT_STATUS != 1) : ?>
                    <div class="ibox-tools">
                            <span id="update_personalInfo_btn" title="Update Personal Info"
                                  ...
                                  data-action="applicant/updateApplicantPersonalDetails"> Edit </span>
                    </div>
                <?php endif; ?>
            </div>
                ...
                <div class="table-responsive contentArea">
                    <table class="table table-striped table-bordered table-hover gridTable">
                        ...
                        <tr>
                            ...
                            <th>Roll No.</th>
                            <td>:</td>
                            <td><?php echo ($applicant_info->ADM_ROLL_NO != '') ? " $applicant_info->ADM_ROLL_NO " : "" ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <!--                            <td>-->
                            <?php //echo ($applicant_info->DATH_OF_BIRTH !='')? " $applicant_info->DATH_OF_BIRTH " :"" ?><!--</td>-->
                            <td><?php $dob = date('d-M-Y', strtotime($applicant_info->DATH_OF_BIRTH));
                                echo ($dob != '') ? " $dob " : "" ?></td>
                        </tr>
                        <tr>
                        ...
                        <!--                            <td>:</td>-->
                        <!--                            <td>-->
                        <?php ////echo ($applicant_info->SPOUSE_NAME !='')? " $applicant_info->SPOUSE_NAME " :"" ?><!--</td>-->
                        <!--                        </tr>-->
                        <tr>
                            <th>Nationality</th>
                            <td>:</td>
                        ...
                        <!--                            <td>:</td>-->
                        <!--                            <td>-->
                        <?php //echo ($applicant_info->PASSPORT_NO !='')? " $applicant_info->PASSPORT_NO " :"" ?><!--</td>-->
                        <!--                        </tr>-->
                        <tr>
                            <th>Email</th>
                            <td>:</td>
