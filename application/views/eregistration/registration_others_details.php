<!--<h4 class="green">Other Details</h4>-->
<div class="ibox-title">
    <h5>Other Details</h5>
    <?php  if ($applicant_info->ELIGIBLE_BY_ADDMISSION_DEPT_STATUS != 1) : ?>
        <div class="ibox-tools">
                            <span id="update_othersInfo_btn" title="Update Other Details Info" class="btn btn-primary btn-xs pull-right"
                                  data-action="applicant/updateApplicantOtherDetailsInfo"> Edit </span>
        </div>
    <?php endif; ?>
</div>
    ...
    <div class="table-responsive contentArea">
        <table class="table table-striped table-bordered table-hover gridTable">
            ...
            <tr>
                ...
                <td>:</td>
                <td><?php echo ($applicant_info->APPLY_BEFORE !='NO')? 'Semester: '." $applicant_info->APPLY_SEMESTER ".'Year: '." $applicant_info->APPLY_YEAR " :"NO" ?></td>
