...
<!--<button id="update_academic_btn" class="btn btn-primary btn-xs">Edit</button>-->
<div class="ibox-title">
    <h5>Academic Information</h5>
    <?php  if ($applicant_info->ELIGIBLE_BY_ADDMISSION_DEPT_STATUS != 1) : ?>
        <div class="ibox-tools">
                            <span id="update_academic_btn" title="Update Academic Info" class="btn btn-primary btn-xs pull-right"
                                  data-action="applicant/updateApplicantAcademicInfo"> Edit </span>
        </div>
    <?php  endif; ?>
</div>
