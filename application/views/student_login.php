...
<div class="loginColumns animated fadeInDown">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <h3 class="font-bold" style="color: green">Student Login</h3>
            ...
            <div class="ibox-content">
                ...
                <form class="m-t" role="form" action="" method="post">
                    <div class="form-group">
                        <input type="text" name="stu_user_name" value="<?php echo set_value('user_name'); ?>"
                               class="form-control" placeholder="Registration No.">
                    </div>
                    <div class="form-group">
                        <input type="password" name="stu_password" value="<?php echo set_value('password'); ?>"
                               class="form-control" placeholder="Password">
                    </div>
                    <input type="submit" class="btn btn-primary block full-width m-b" value="Login">
                    <a href="<?php echo base_url();?>auth/forgotStudentPassword">
