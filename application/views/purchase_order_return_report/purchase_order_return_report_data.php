    ...
    <div id='printablediv'>
     ...
     <hr style="border-color:orange;"><br><p align="center" style="font-size: 16px;"><b>Purchase Order Return Report</b><br><span style="float:center;font-size: 14px;"><?php echo $fromDate = date('d/M/Y', strtotime($this->input->post('fromDate'))); ?>-<?php echo $toDate = date('d/M/Y', strtotime($this->input->post('toDate'))); ?></span></p></div>
<!-- 
    ...
    <table id="" border="1" rules="all" class="table table-striped table-bordered table-hover printable table-sm no-footer centered" cellspacing="0" width="100%" role="grid">
      ...
      <tbody>
       <?php $sn = 1; ?>
       <?php foreach ($purchaseorder_return_item_info_report as $row): ?>

        <tr>
         <td style="text-align: center;"><?php echo $sn++; ?></td>
         <td><?php echo $row->ITEM_NAME; ?> </td>
         <td style="text-align: center;"><?php echo $row->TOTAL_RET_RECEIVE_QTY; ?> (<?php echo $row->UNIT_NAME; ?>)</td>
       </tr>
     <?php endforeach; ?>
