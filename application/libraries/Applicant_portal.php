...
class Applicant_portal {
    ...
    function display($data = null) {
        ...
        $data['_content'] = $this->_ci->load->view((isset($data['content_view_page']) == '') ? 'applicant_portal/content' : $data['content_view_page'], $data, true);
        $this->_ci->load->view('applicant_portal.php', $data);
    }
